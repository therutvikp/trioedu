...
use Modules\TrioBiometrics\Entities\TrioBioSetting;
...
class SmApiController extends Controller
{
    ...
    public function AttendanceSync(Request $request)
    {
        ...
        try {
            ...
            $attendance_setting = TrioBioSetting::find(1);
    ...
    public function saveUploadContent(Request $request)
    {
        ...
        try {
            ...
            foreach ($request->available_for as $value) {
                if ($value == 'admin') {
                    $roles = TrioRole::where('id', '=', 1) /* ->where('id', '!=', 2)->where('id', '!=', 3)->where('id', '!=', 9) */ ->where('academic_id', SmAcademicYear::SINGLE_SCHOOL_API_ACADEMIC_YEAR())->where(function ($q): void {
                        $q->where('school_id', Auth::user()->school_id)->orWhere('type', 'System');
                    })->get();
    ...
    public function staffList(Request $request)
    {
        ...
        try {
            ...
            $roles = TrioRole::where('active_status', '=', '1')->where('id', '!=', 2)->where('id', '!=', 3)->where(function ($q): void {
    ...
    public function staffRoles(Request $request)
    {
        ...
        try {
            $roles = TrioRole::where('active_status', '=', '1')
    ...
    public function searchStaff(Request $request)
    {
        ...
        try {
            ...
            $staffs = $staff->get();
            $roles = TrioRole::where('active_status', '=', '1')->where('id', '!=', 2)->where('id', '!=', 3)->get();
    ...
    public function staffAttendance(Request $request)
    {
        ...
        try {
            $roles = TrioRole::where('active_status', '=', '1')->where('id', '!=', 1)->where('id', '!=', 2)->where('id', '!=', 3)->where('id', '!=', 10)->where(function ($q): void {
                $q->where('school_id', Auth::user()->school_id)->orWhere('type', 'System');
            })->get();
    ...
    public function saas_staffAttendance(Request $request, $school_id)
    {
        ...
        try {
            $roles = TrioRole::where('active_status', '=', '1')->where('id', '!=', 1)->where('id', '!=', 2)->where('id', '!=', 3)->where('id', '!=', 10)
                ->where('school_id', $school_id)->get();
    ...
    public function staffAttendanceReportSearch(Request $request)
    {
        ...
        try {
            ...
            $roles = TrioRole::where('id', '!=', 3)->where('id', '!=', 2)->where(function ($q): void {
                $q->where('school_id', Auth::user()->school_id)->orWhere('type', 'System');
            })->get();
    ...
    //         $roles = TrioRole::where('id', '!=', 1)->where('id', '!=', 2)->where('id', '!=', 3)->where(function ($q) {
    //             $q->where('school_id', Auth::user()->school_id)->orWhere('type', 'System');
    //         })->get();
    //         if (ApiBaseMethod::checkUrl($request->fullUrl())) {
    //             $data = [];
    ...
    public function saas_Approve_Leave_index(Request $request, $school_id)
    {
        ...
        try {
            ...
            $roles = TrioRole::where('id', '!=', 1)->where('id', '!=', 2)->where('id', '!=', 3)->where(function ($q): void {
                $q->where('school_id', Auth::user()->school_id)->orWhere('type', 'System');
            })->get();
            if (ApiBaseMethod::checkUrl($request->fullUrl())) {
                $data = [];
    ...
    public function saas_sendMessage(Request $request, $school_id)
    {
        ...
        try {
            $roles = TrioRole::where('school_id', $school_id)->get();
            if (ApiBaseMethod::checkUrl($request->fullUrl())) {
                return ApiBaseMethod::sendResponse($roles, null);
            }
    ...
    {
        try {
            $roles = TrioRole::select('*')->where('id', '!=', 1)->where(function ($q): void {
                $q->where('school_id', Auth::user()->school_id)->orWhere('type', 'System');
            })->get();
    ...
    {
        try {
            $roles = TrioRole::where('active_status', '=', 1)->where('id', '!=', 2)->where('id', '!=', 3)->where('id', '!=', 9)->orderBy('id', 'desc')->where(function ($q): void {
                $q->where('school_id', Auth::user()->school_id)->orWhere('type', 'System');
            })->get();
            if (ApiBaseMethod::checkUrl($request->fullUrl())) {
                return ApiBaseMethod::sendResponse($roles, null);
    ...
    public function role_edit(Request $request, $id)
    {
        try {
            ...
            $roles = TrioRole::where('active_status', '=', 1)->orderBy('id', 'desc')->where(function ($q): void {
                $q->where('school_id', Auth::user()->school_id)->orWhere('type', 'System');
            })->get();
    ...
    public function uploadContent(Request $request)
    {
        ...
        if ($request->input('available_for') == 'admin') {
            $roles = TrioRole::where('id', '!=', 1)->where('id', '!=', 2)->where('id', '!=', 3)->where('id', '!=', 9)->where(function ($q): void {
                $q->where('school_id', Auth::user()->school_id)->orWhere('type', 'System');
            })->get();
    ...
    public function pendingLeave(Request $request)
    {
        ...
        try {
            ...
            $leave_types = SmLeaveType::where('active_status', 1)->get();
            $roles = TrioRole::where('id', '!=', 1)->where('id', '!=', 3)->get();
