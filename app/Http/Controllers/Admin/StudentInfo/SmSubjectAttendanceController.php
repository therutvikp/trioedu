...
class SmSubjectAttendanceController extends Controller
{
    ...
    public function subjectAttendanceReportSearch(StudentSubjectWiseAttendanceSearchRequest $request)
    {
        ...
        */
            ...
            return view('backEnd.studentInformation.subject_attendance_report_view', compact('classes', 'attendances', 'days', 'year', 'month', 'current_day', 'class_id', 'section_id', 'subject_id','shift_id'));
        /*
        } catch (\Exception $e) {
            Toastr::error('Operation Failed', 'Failed');
            return redirect()->back();
    ...
    public function subjectAttendanceReportPrint($class_id, $section_id, $month, $year, $shift_id =null)
    {
        set_time_limit(2700);
        /*
        try {
        */
            ...
            return view('backEnd.studentInformation.student_subject_attendance', compact('attendances', 'days', 'year', 'month', 'class_id', 'section_id', 'shift', 'shift_id'));
        /*
        } catch (\Exception $e) {
            Toastr::error('Operation Failed', 'Failed');
            return redirect()->back();
