...
class SmFeesReportController extends Controller
{
    ...
    public function balanceFeesSearch(Request $request)
    {
        ...
        if (directFees()) {
            ...
            if ($records) {
                return view('backEnd.feesCollection.balance_fees_report', ['records' => $records, 'class_id' => $class_id, 'section_id' => $section_id, 'clas' => $clas, 'classes' => $classes]);
            }
        } else {
            ...
            return view('backEnd.feesCollection.balance_fees_report', ['classes' => $classes, 'balance_students' => $balance_students, 'class_id' => $class_id, 'clas' => $clas, 'data' => $data, 'section_id' => $section_id]);
