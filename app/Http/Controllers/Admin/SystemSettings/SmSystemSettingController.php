...
//                $files[] = $key;
    ...
    public function updateGeneralSettings(Request $request)
    {
        ...
        $languages = SmLanguage::where('school_id',$user->school_id)->get();
        $countries = SmCountry::select('currency')->distinct('currency')->get();
        $currencies = SmCurrency::where('school_id',$user->school_id)->get();
    ...
    public function updatePaymentGateway(PaymentGatewayFormRequest $request)
    {
        ...
        */
            $paymeny_gateway = [
                ...
                'phone_pay_merchant_id', 'phone_pay_salt_key', 'phone_pay_salt_index','ssl_store_name','ssl_store_id','ssl_store_password','ssl_environment'
    ...
    public function DbUpgrade()
    {
        ...
        try {
        */
            if (!Schema::hasTable('trio_module_managers')) {
                Artisan::call('migrate --path=/database/migrations/2020_06_10_193309_create_trio_module_managers_table.php');
            }
