...
class SmClassRoutineNewController extends Controller
{
    ...
    public function addNewClassRoutine($class_time_id, $day, $class_id, $section_id)
    {
        ...
        try {
            ...
            return view('backEnd.academics.add_new_class_routine_form', ['rooms' => $rooms, 'subjects' => $subjects, 'day' => $day, 'class_time_id' => $class_time_id, 'class_id' => $class_id, 'section_id' => $section_id, 'assinged_subject' => $assinged_subject, 'assinged_room' => $assinged_room]);
        } catch (Exception $exception) {
            Toastr::error('Operation Failed', 'Failed');
    ...
    {
        try {
            if (! property_exists($request, 'assigned_id') || $request->assigned_id == null) {
    ...
    public function classRoutineReportSearch(Request $request)
    {
        ...
        try {
            ...
            return view('backEnd.reports.class_routine_report', ['classes' => $classes, 'class_times' => $class_times, 'class_id' => $class_id, 'section_id' => $section_id, 'sm_routine_updates' => $sm_routine_updates, 'sm_weekends' => $sm_weekends]);
        } catch (Exception $exception) {
    ...
    public function deleteClassRoutineModal($id)
    {
        ...
        try {
            return view('backEnd.academics.delete_class_routine', ['id' => $id]);
        } catch (Exception $exception) {
            Toastr::error('Operation Failed', 'Failed');
