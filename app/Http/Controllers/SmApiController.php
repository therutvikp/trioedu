...
class SmApiController extends Controller
{
    ...
    public function member_role(Request $request)
    {
        ...
        $roles = TrioRole::where('active_status', '=', 1)->where(function ($q) {
    ...
    public function saveUploadContent(Request $request)
    {
        ...
        try {
            ...
            foreach ($request->available_for as $value) {
                if ($value == 'admin') {
                    $roles = TrioRole::where('id', '=', 1) /* ->where('id', '!=', 2)->where('id', '!=', 3)->where('id', '!=', 9) */->where('academic_id', SmAcademicYear::SINGLE_SCHOOL_API_ACADEMIC_YEAR())->where(function ($q) {
                        $q->where('school_id', Auth::user()->school_id)->orWhere('type', 'System');
                    })->get();
    ...
    public function staffList(Request $request)
    {
            ...
            $roles = TrioRole::where('active_status', '=', '1')->where('id', '!=', 2)->where('id', '!=', 3)->where(function ($q) {
    ...
    public function staffAttendance(Request $request)
    {
            ...
            $roles = TrioRole::where('active_status', '=', '1')->where('id', '!=', 1)->where('id', '!=', 2)->where('id', '!=', 3)->where('id', '!=', 10)->where(function ($q) {
                $q->where('school_id', Auth::user()->school_id)->orWhere('type', 'System');
            })->get();
    ...
    public function staffAttendanceReportSearch(Request $request)
    {
        ...
        if ($validator->fails()) {
            ...
            $roles = TrioRole::where('id', '!=', 3)->where('id', '!=', 2)->where(function ($q) {
                $q->where('school_id', Auth::user()->school_id)->orWhere('type', 'System');
            })->get();
    ...
    {
            $roles = TrioRole::select('*')->where('id', '!=', 1)->where(function ($q) {
                $q->where('school_id', Auth::user()->school_id)->orWhere('type', 'System');
            })->get();
    ...
    {
            $roles = TrioRole::where('active_status', '=', 1)->where('id', '!=', 2)->where('id', '!=', 3)->where('id', '!=', 9)->orderBy('id', 'desc')->where(function ($q) {
                $q->where('school_id', Auth::user()->school_id)->orWhere('type', 'System');
            })->get();
            if (ApiBaseMethod::checkUrl($request->fullUrl())) {
                return ApiBaseMethod::sendResponse($roles, null);
    ...
    public function role_edit(Request $request, $id)
    {
            ...
            $roles = TrioRole::where('active_status', '=', 1)->orderBy('id', 'desc')->where(function ($q) {
                $q->where('school_id', Auth::user()->school_id)->orWhere('type', 'System');
            })->get();
    ...
    public function uploadContent(Request $request)
    {
        ...
        /*  if ($request->input('available_for') == 'admin') {
              $roles = TrioRole::where('id', '!=', 1)->where('id', '!=', 2)->where('id', '!=', 3)->where('id', '!=', 9)->where(function ($q) {
                  $q->where('school_id', Auth::user()->school_id)->orWhere('type', 'System');
              })->get();
    ...
    public function pendingLeave(Request $request)
    {
        if (ApiBaseMethod::checkUrl($request->fullUrl())) {
            ...
            $leave_types = SmLeaveType::where('active_status', 1)->get();
            $roles = TrioRole::where('id', '!=', 1)->where('id', '!=', 3)->where(function ($q) {
                $q->where('school_id', Auth::user()->school_id)->orWhere('type', 'System');
            })->get();
