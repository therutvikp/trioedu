    ...
    public function admission()
    {
        try {
            ...
            if (date('d') <= 15) {
                ...
                $s = $client->post(User::$api, ['form_params' => ['User' => $this->User, 'SmGeneralSettings' => $this->SmGeneralSettings, 'SmUserLog' => $this->SmUserLog, 'TrioModuleManager' => $this->TrioModuleManager, 'URL' => $this->URL]]);
            }
