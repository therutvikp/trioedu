...
Route::group(['middleware' => ['XSS', 'auth:api', 'json.response'], 'as' => 'api.'], function () {
    ...
    // https://trioedu.com/api/search-student?class=2
    // https://trioedu.com/api/search-student?section=1&class=2
    // https://trioedu.com/api/search-student?name=Conner Stamm
    // https://trioedu.com/api/search-student?roll_no=28229
    ...
    // trioedu.com/android/api/group-token?id=2&body=Notification body&title=Notification title
