        ...
        for ($i = 1; $i <= 200; $i++) {
            ...
            for ($class_id = 1; $class_id <= 1; $class_id++) {
                for ($section_id = 1; $section_id <= 1; $section_id++) {
                    ...
                    $studentEmail = strtolower($student_User_Name) . $i . '@trioedu.com';
                    ...
                    $newUser->email     = $Guardian_First_Name . $i . '@trioedu.com';
                    $newUser->username  = $Guardian_First_Name . $i . '@trioedu.com';
                    $newUser->password  = Hash::make(123456);
                    ...
                    $parent->guardians_email      = $Guardian_First_Name . $i . '@trioedu.com';
