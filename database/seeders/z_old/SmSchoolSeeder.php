        ...
        SmSchool::factory()->times(1)->create()->each(
            function ($school) {
                ...
                SmAcademicYear::factory()->times(1)->create([
                    ...
                    $classes=SmClass::factory()->times(2)->create($school_academic)->each(function ($class) use ($sections, $school_academic, $school, $subjects, $teacher_id, $rooms, $academic_year) {
                        ...
                        foreach ($class_sections as $data) {
                            ...
                            for ($i = 1; $i <= 5; $i++) {                                
                                User::factory()->times(1)->create([
                                    'role_id' =>2,
                                    'email'=>'student_'.$data->class_id.'_'.$data->section_id.'_'.$i.'@trioedu.com', 
                                    'username'=>'student_'.$data->class_id.'_'.$data->section_id.'_'.$i.'@trioedu.com',
                                    'school_id' =>$school->id,
                                ]);
                                User::factory()->times(1)->create([
                                    'role_id' =>3,
                                    'email'=>'guardian_'.$data->class_id.'_'.$data->section_id.'_'.$i.'@trioedu.com', 
                                    'username'=>'guardian_'.$data->class_id.'_'.$data->section_id.'_'.$i.'@trioedu.com',
                                    'school_id' =>$school->id,
                                ]);
                    ...
                    $rules = TrioRole::where('is_saas',0)->where('active_status', '=', '1')->where('id', '!=', 1) /* ->where('id', '!=', 2) */->where('id', '!=', 3)->where('id', '!=', 10)->get();
                ...
                foreach ($ids as $id) {
                    $permission = TrioPermissionAssign::where('school_id', $school->id)->where('role_id', 5)->where('module_id', $id)->first();
                    if ($permission) {
                        $permission->delete();
                    }
                }
                ...
                $s->link_label1 = 'About Trio';
                $s->link_href1  = 'http://trioedu.com';
        
                $s->link_label2 = 'Trio Home';
                $s->link_href2  = 'http://trioedu.com/home';
        
                $s->link_label3 = 'Business';
                $s->link_href3  = 'http://trioedu.com';
        
                $s->link_label4 = 'link_label4';
                $s->link_href4  = 'http://trioedu.com';
        
                $s->link_label5 = 'link_label5';
                $s->link_href5  = 'http://trioedu.com';
        
                $s->link_label6 = 'link_label6';
                $s->link_href6  = 'http://trioedu.com';
        
                $s->link_label7 = 'link_label7';
                $s->link_href7  = 'http://trioedu.com';
        
                $s->link_label8 = 'link_label8';
                $s->link_href8  = 'http://trioedu.com';
        
                $s->link_label9  = 'Home';
                $s->link_href9   = 'http://trioedu.com/home';
        
                $s->link_label10 = 'About';
                $s->link_href10  = 'http://trioedu.com/about';
        
        
                $s->link_label11 = 'Contact';
                $s->link_href11  = 'http://trioedu.com/contact';
        
                $s->link_label12 = 'link_label12';
                $s->link_href12  = 'http://trioedu.com';
        
                $s->link_label13 = 'link_label13';
                $s->link_href13  = 'http://trioedu.com';
        
                $s->link_label14 = 'link_label14';
                $s->link_href14  = 'http://trioedu.com';
        
                $s->link_label15 = 'link_label15';
                $s->link_href15  = 'http://trioedu.com';
        
                $s->link_label16 = 'link_label16';
                $s->link_href16  = 'http://trioedu.com';
                $s->school_id = $school->id; 
                $s->save();
