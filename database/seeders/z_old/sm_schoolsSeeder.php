    ...
    public function run()
    {
        ...
        if($allData['Saas'] == TRUE){
            ...
            for($i=2; $i<=5; $i++){
                ...
                $staff->school_id       = $i;
                $staff->email           = $email;
                $staff->staff_photo     = 'public/uploads/staff/1_trio_edu.jpg';
                ...
                DB::table('sm_testimonials')->insert([
                    [
                        ...
                        'description' => 'its vast! Trio has more additional feature that will expect in a complete solution.',
                ...
                for ($role_id = 4; $role_id <10; $role_id++) {
                    ...
                    $newUser->email     = $First_Name . $j . '@trioedu.com';
                    $newUser->username  = $First_Name . $j . '@trioedu.com';
                    ...
                    DB::table('sm_staffs')->insert([
                        ...
                        [
                            ...
                            'gender_id'        => $gender_id,
                            'email'            => $First_Name . $j . '@trioedu.com',
                            'mobile'           => '123456789',
                ...
                for ($j = 1; $j <= 20; $j++) {
                                ...
                                $studentEmail = strtolower($student_User_Name) . $j . '@trioedu.com';
                                ...
                                $newUser->email     = strtolower($Father_User_Name).'_pa' . $j . '@trioedu.com';
                                $newUser->username  = strtolower($Father_User_Name).'_pa' . $j . '@trioedu.com';
                                $newUser->password  = Hash::make(123456);
                                ...
                                $parent->guardians_email      = $Guardian_First_Name . $j . '@trioedu.com';
            ...
            $findSaas= TrioModuleManager::where('name','Saas')->first();
            $saasPurchase= TrioModuleManager::find($findSaas->id);
