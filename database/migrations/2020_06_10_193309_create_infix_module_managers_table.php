...
class CreateTrioModuleManagersTable extends Migration
{
    /**
     * Run the migrations.
     */
    ...
    {
        Schema::create('trio_module_managers', function (Blueprint $blueprint): void {
        ...
        try {
            ...
            $s->update_url = 'https://spondonit.com/contact';
            $s->is_default = 0;
            $s->addon_url = 'https://codecanyon.net/item/razorpay-payment-gateway-for-trioedu/27721206?s_rank=11';
            $s->installed_domain = url('/');
            $s->activated_date = date('Y-m-d');
            $s->save();
            ...
            $s->activated_date = date('Y-m-d');
            $s->save();
            $bulk_print = new TrioModuleManager();
            ...
            $bulk_print->addon_url = 'https://codecanyon.net/item/trioedu-zoom-live-class/27623128?s_rank=12';
            $bulk_print->installed_domain = url('/');
            $bulk_print->activated_date = date('Y-m-d');
            $bulk_print->save();
            $HimalayaSms = new TrioModuleManager();
            ...
            $HimalayaSms->save();
            $XenditPayment = new TrioModuleManager();
            ...
            // TrioBiometrics
            $s = new TrioModuleManager();
            $s->name = 'TrioBiometrics';
            $s->email = 'support@spondonit.com';
            $s->notes = 'This is TrioBiometrics module for live virtual class and meeting in this system at a time. Thanks for using.';
            $s->version = '1.0';
            $s->update_url = 'https://spondonit.com/contact';
            $s->is_default = 0;
            $s->addon_url = 'https://codecanyon.net/item/trioedu-zoom-live-class/27623128?s_rank=12';
            ...
            $s->update_url = 'https://spondonit.com/contact';
            $s->is_default = 0;
            $s->addon_url = 'https://codecanyon.net/item/google-meet-module-for-trioedu-gmeet-live-class/42463761';
            $s->installed_domain = url('/');
            $s->activated_date = date('Y-m-d');
            $s->save();
            ...
            $s->name = 'CcAveune';
            $s->email = 'support@spondonit.com';
            $s->notes = 'This CcAveune Module For TrioEdu . Manage online payment for fees & wallet.';
            $s->version = '1.0';
            $s->update_url = 'https://spondonit.com/contact';
            $s->is_default = 0;
            ...
            $s->email = 'support@spondonit.com';
            $s->notes = 'This InAppLiveClass Module For TrioEdu . Manage Online Class and Meeting Reports.';
            $s->version = '1.0';
            $s->update_url = 'https://spondonit.com/contact';
            $s->is_default = 0;
            $s->addon_url = 'maito:support@spondonit.com';
    ...
    {
        Schema::dropIfExists('trio_module_managers');
    }
}
