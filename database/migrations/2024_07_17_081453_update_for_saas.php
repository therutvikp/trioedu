...
return new class extends Migration
{
    ...
    public function up(): void
    {
        ...
        $exist = TrioModuleManager::where('name', 'News')->first();
        if (! $exist) {
            $name = 'News';
        ...
        $exist = TrioModuleManager::where('name', 'PDF')->first();
        if (! $exist) {
            $name = 'PDF';
            $s = new TrioModuleManager();
            $s->name = $name;
        ...
        $exist = TrioModuleManager::where('name', 'SaasHr')->first();
        if (! $exist) {
            $name = 'SaasHr';
            $s = new TrioModuleManager();
            $s->name = $name;
        ...
        $exist = TrioModuleManager::where('name', 'Forum')->first();
        if (! $exist) {
            $name = 'Forum';
            $s = new TrioModuleManager();
            $s->name = $name;
        ...
        $exist = TrioModuleManager::where('name', 'CustomMenu')->first();
        if (! $exist) {
            $name = 'CustomMenu';
            $s = new TrioModuleManager();
            $s->name = $name;
