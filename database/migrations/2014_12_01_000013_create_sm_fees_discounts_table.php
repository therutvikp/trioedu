...
class CreateSmFeesDiscountsTable extends Migration
{
    ...
    {
        Schema::create('sm_fees_discounts', function (Blueprint $blueprint): void {
            $blueprint->increments('id');
            $blueprint->string('name', 200)->nullable();
            $blueprint->string('code', 200)->nullable();
            $blueprint->enum('type', ['once', 'year'])->nullable()->comment('once for one time, year for all months');
