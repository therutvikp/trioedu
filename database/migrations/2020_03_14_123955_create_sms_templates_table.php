...
class CreateSmsTemplatesTable extends Migration
{
    ...
    public function up(): void
    {
        ...
        $allTempletes = [
            ...
            // Module Name : TrioBiometrics
            ['sms', 'student_early_checkout', '', 'Dear parent [parent_name], your child [student_name] is checkout  at [attendance_date] to the school on [attendance_date], Thank You [school_name]', 'TrioBiometrics', '[parent_name], [student_name], [attendance_date], [attendance_date], [school_name]'],
            ['sms', 'student_checkout', '', 'Dear Parent [parent_name], your child [student_name] left the school at [left_time], Thank You [school_name]', 'TrioBiometrics', '[parent_name], [student_name], [school_name]'],
