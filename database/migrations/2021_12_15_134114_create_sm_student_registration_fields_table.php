...
class CreateSmStudentRegistrationFieldsTable extends Migration
{
    ...
    public function up(): void
    {
        ...
        $trioModuleInfo = new TrioModuleInfo();
        $trioModuleInfo->id = 951;
        $trioModuleInfo->module_id = 3;
        $trioModuleInfo->parent_id = 61;
        $trioModuleInfo->type = '2';
        $trioModuleInfo->is_saas = 0;
        $trioModuleInfo->route = 'Student Settings';
        $trioModuleInfo->lang_name = 'student_settings';
        $trioModuleInfo->icon_class = 'student_settings';
        $trioModuleInfo->active_status = 1;
        $trioModuleInfo->created_by = 1;
        $trioModuleInfo->updated_by = 1;
        $trioModuleInfo->school_id = 1;
        $trioModuleInfo->save();
