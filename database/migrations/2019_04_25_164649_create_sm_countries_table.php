...
class CreateSmCountriesTable extends Migration
{
    ...
    {
        Schema::create('sm_countries', function (Blueprint $blueprint): void {
            ...
            $blueprint->string('native', 255)->nullable();
            $blueprint->string('phone', 255)->nullable();
            $blueprint->string('continent', 255)->nullable();
            $blueprint->string('capital', 255)->nullable();
            $blueprint->string('currency', 255)->nullable();
            $blueprint->string('languages', 255)->nullable()->charset('utf8')->collate('utf8_general_ci');
