...
@section('mainContent')
    ...
    <section class="admin-visitor-area up_admin_visitor">
        <div class="container-fluid p-0">
            ...
            {{ html()->form('POST', route('staff-id-card-bulk-print-search'))->attributes([
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-6 mt-30-md" id="id-card-div">
                                <div class="col-lg-12 " id="selectSectionsDiv" style="margin-top: -25px;">
                                    <label for="checkbox" class="mb-2">@lang('common.role') <span class="text-danger">
                                            *</span></label>
                    ...
                    success: function(data) {
                        ...
                        $.each(data, function(i, item) {
                            if (item.length) {
                                ...
                                $("#selectSectionsDiv ul").find("li").not(":first")
                                    .remove();
                                ...
                                $("#selectSectionsDiv .current").html(
                                    "SELECT SECTION *");
                                $("#selectSectionss").find("option").not(":first")
                                    .remove();
                                $("#selectSectionsDiv ul").find("li").not(":first")
                                    .remove();
                            }
