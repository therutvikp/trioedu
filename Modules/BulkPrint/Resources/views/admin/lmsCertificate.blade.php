...
@section('mainContent')
    ...
    <section class="admin-visitor-area up_admin_visitor">
        <div class="container-fluid p-0">
            ...
            {{ html()->form('POST', route('lms-certificate-bulk-print-seacrh'))->attributes(['class' => 'form-horizontal'])->open() }}
            <div class="row">
                <div class="col-lg-12">
                    <div class="white-box">
                        <div class="row">
                            ...
                            <div class="col-lg-9 mt-30-md">
                                <select
                                    class="primary_select new_test w-100 bb form-control {{ @$errors->has('course_id') ? ' is-invalid' : '' }}"
                                    name="course_id">
                                    <option data-display="@lang('lms::lms.course') @lang('lms::lms.name') *" value="">
                                        @lang('lms::lms.course') @lang('lms::lms.name') *</option>
                                    @foreach ($courses as $course)
                                        <option value="{{ $course->id }}" {{ old('course_id') ? 'selected' : '' }}>
