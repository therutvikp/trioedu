...
class CreateTrioModuleStudentParentInfosTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('trio_module_student_parent_infos', function (Blueprint $table) {
            $table->increments('id');
        ...
        // DB::table('trio_module_student_parent_infos')->truncate();
      ...
      //  -- Wallet
       ...
       foreach($datas as $data){
            $new = new TrioModuleStudentParentInfo();
            $new->id = $data[0];
    ...
    {
        Schema::dropIfExists('trio_module_student_parent_infos');
    }
}
