...
<div class="role_permission_wrap">
    ...
    @php
        ...
        $module_info = Modules\RolePermission\Entities\TrioModuleInfo::where('module_id', $key)->where('active_status',1)->where('parent_id', 0)->first();

        $all_group_modules = Modules\RolePermission\Entities\TrioModuleInfo::where('module_id', $key)->where('active_status',1)->where('id', '!=', $key)->get();
                                ...
                                <ul>
                                    ...
                                    <li>
                                        ...
                                        <?php
                                            ...
                                            $childModule= DB::table('trio_module_infos')->where('active_status',1)->where('parent_id',$row2->id)->get();
                                        ?>
