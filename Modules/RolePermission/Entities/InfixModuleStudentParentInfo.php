...
class TrioModuleStudentParentInfo extends Model
{
    ...
    public function subModule()
    {
        ...
        return $this->hasMany('Modules\RolePermission\Entities\TrioModuleStudentParentInfo', 'parent_route', 'route')->whereNotNull('route')->where('route', '!=', '')
