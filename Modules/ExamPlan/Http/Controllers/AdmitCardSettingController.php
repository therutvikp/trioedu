    ...
    public function universityAdmitCardSearch($request)
    {
        ...
        try {
            ...
            if ($exam_routine) {
                ...
                return view('examplan::admitCard', ['records' => $records, 'exam_id' => $exam_id, 'class_id' => $class_id, 'old_admit_ids' => $old_admit_ids]);
            }
    ...
    public function admitcardSearch(Request $request)
    {
        ...
        try {
            ...
            if ($exam_routine) {
                ...
                return view('examplan::admitCard', ['exams' => $exams, 'classes' => $classes, 'records' => $records, 'exam_id' => $exam_id, 'class_id' => $class_id, 'old_admit_ids' => $old_admit_ids, 'shift_id' => $shift_id, 'section_id' => $section_id]);
            }
