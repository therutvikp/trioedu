...
class StudentAbsentNotificationController extends Controller
{
    public function index()
    {
        ...
        return view('studentabsentnotification::index', ['setups' => $setups]);
    }
    ...
    public function store(Request $request)
    {
        ...
        try {
            $absentNotificationTimeSetup = new AbsentNotificationTimeSetup();
            $absentNotificationTimeSetup->time_from = date('H:i', strtotime($request->start_time));
            $absentNotificationTimeSetup->time_to = date('H:i', strtotime($request->end_time));
            $absentNotificationTimeSetup->active_status = $request->active_status;
            $absentNotificationTimeSetup->school_id = Auth::user()->school_id;
            $absentNotificationTimeSetup->save();
    ...
    public function edit($id)
    {
        ...
        return view('studentabsentnotification::index', ['setups' => $setups, 'editData' => $editData]);
    }
