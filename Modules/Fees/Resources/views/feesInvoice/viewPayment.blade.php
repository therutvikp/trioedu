                        ...
                        <tr>
                            ...
                            <td>
                                @if (
                                    ...
                                    {{ html()->form('POST', route('fees.change-method'))->attributes(['class' => 'form-horizontal', 'id' => 'feesChangeMethod'])->open() }}
                                    ...
                                    <div class="mt-30-md">
                                        ...
                                        <div class="row mt-25">
                                            <div class="primary_input">
                                                <label class="primary_input_label">@lang('common.note') <span></span>
                                                </label>
