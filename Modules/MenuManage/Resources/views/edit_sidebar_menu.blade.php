                                                    ...
                                                    <div id="Role{{ $module_info->id }}" class="collapse">
                                                        <div class="permission_body">
                                                            <ul>
                                                                ...
                                                                $subModule = DB::table('sidebars')->where('parent_id', $module_info->trio_module_id)->where('active_status', 1)->get();
                                                                ?>
                                        ...
                                        @foreach ($all_modules as $key => $row)
                                            @php
                                                ...
                                                if (moduleStatusCheck('SaasRolePermission') == true) {
                                                    $module_info = Modules\RolePermission\Entities\TrioModuleInfo::where(
                                                        'module_id',
                                                        $key,
                                                    )->first();
                                                    $all_group_modules = Modules\RolePermission\Entities\TrioModuleInfo::where(
                                                        'module_id',
                                                        $key,
                                                    )
                                                        ->where('id', '!=', $key)
