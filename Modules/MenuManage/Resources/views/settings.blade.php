...
@section('mainContent')
    ...
    <div class="row">
        <div class="col-lg-12 mb_20">
            <div class="white-box">
                {{ html()->form('POST', route('menumanage.settings'))->open() }}
                                        ...
                                        <div class="row">
                                            <div class="col-lg-3">
                                                <div class="">
                                                    ...
                                                    <label
                                                        for="role_based_sidebar_{{ $school->id }}_enable">{{ __('common.enable') }}</label>
                                                </div>
                                            </div>
                                            <div class="col-lg-3">
                                                <div class="">
                                                    <input type="radio" name="role_based_sidebar[{{ $school->id }}]"
                                                        ...
                                                        @if (!$school->settings->role_based_sidebar) checked @endif>
                                                    <label
                                                        for="role_based_sidebar_{{ $school->id }}_disable">{{ __('common.disable') }}</label>
                                                </div>
                                            </div>
