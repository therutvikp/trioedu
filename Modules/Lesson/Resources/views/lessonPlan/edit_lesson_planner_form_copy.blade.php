            ...
            <div class="row mt-25">
                ...
                <div class="col-lg-4">
                    <select
                        ...
                        id="select_lesson" onchange="changeLesson()" name="lesson">
                ...
                <div class="col-lg-4" id="select_topic_div">
                    ...
                    <select
                        class="primary_select form-control{{ $errors->has('section') ? ' is-invalid' : '' }} select_topic"
                ...
                <div class="col-lg-4 mt-30-md">
                    <div class="primary_input">
                        <input name="sub_topic" value="{{ $lessonPlanDetail->sub_topic }}"
    ...
    <div class="row mt-25">
        <div class="col-lg-6 mt-30-md">
            <div class="primary_input">
                ...
                <textarea name="teaching_method" class="primary_input_field form-control" id="" cols="50"
                    rows="2">{{ $lessonPlanDetail->teaching_method }}</textarea>
            </div>
        </div>
        <div class="col-lg-6 mt-30-md">
            <div class="primary_input">
                <label id="teacher_label">@lang('lesson::lesson.general_objectives')</label>
                <textarea name="general_Objectives" id="" cols="50" rows="2"
                    class="primary_input_field form-control">{{ $lessonPlanDetail->general_objectives }}</textarea>
            </div>
        </div>
    </div>
    <div class="row mt-25">
        <div class="col-lg-6 mt-30-md">
            <div class="primary_input">
                ...
                <textarea name="previous_knowledge" id="" cols="50" rows="2"
                    class="primary_input_field form-control">{{ $lessonPlanDetail->previous_knowlege }}</textarea>
            </div>
        </div>
        <div class="col-lg-6 mt-30-md">
            <div class="primary_input">
                <label id="teacher_label">@lang('lesson::lesson.comprehensive_questions')</label>
                <textarea name="comprehensive_Questions" id="" cols="50" rows="2"
                    class="primary_input_field form-control">{{ $lessonPlanDetail->comp_question }}</textarea>
            </div>
        </div>
    </div>
    <div class="row mt-25">
