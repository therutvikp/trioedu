        ...
        <div class="col-lg-12">
            ...
            <div class="row">
                ...
                <div class="col-lg-12">
                    <select class="primary_select form-control{{ $errors->has('section') ? ' is-invalid' : '' }} "
                        id="lessonTopicEdit"name="lesson">
            ...
            @foreach ($lessonPlanDetail->topics as $item)
                <div class="row mt-25" id="topic_edit_row_{{ $item->id }}">
                    ...
                    <div class="col-lg-{{ generalSetting()->sub_topic_enable ? 5 : 10 }} select_edit_topic_div"
                        id="select_edit_topic_div">
                    ...
                    <div class="col-2">
                        <button class="removeTopiceRowBtn primary-btn icon-only fix-gr-bg" type="button"
                            data-lessonplantopic_id="{{ $item->id }}">
                ...
                if (data.length) {
                    $.each(data, function(i, item) {
                        if (item.length) {
                            ...
                            $("#select_edit_topic_div ul").find("li").not(":first")
                        .remove();
