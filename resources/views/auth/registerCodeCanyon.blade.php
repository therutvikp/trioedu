                ...
                <div class="col-sm-8 col-lg-5 col-xl-4 col-md-7">
                    ...
                    <div class="in_login_content">
                        ...
                        <div class="in_login_page_iner">
                            ...
                            <form method="POST" class="loginForm" action="{{route('customer_register')}}" id="trio_form">
                                @csrf
                            ...
                            {{-- @if (moduleStatusCheck('Saas') == TRUE) --}}
                                    <div class="primary_input mb-40 in_single_input">
                                        <select class="mb-26 niceSelect trio_theme_style w-100 bb form-control{{ $errors->has('school_id') ? ' is-invalid' : '' }}" name="school_id" id="select-school">
