...
<head>
    ...
    <link rel="alternate" href="http://trioedu.com" hreflang="en-us" />
    ...
    <link rel="stylesheet" href="{{asset('public/backEnd/')}}/css/trio.css"/>
        ...
        <div class="card">
            ...
            <div class="single-report-admit">
                <div class="card-header">
                    <h2 class="text-center text-uppercase" style="color: whitesmoke">Welcome to Trioedu </h2>
                
                </div>
            </div>

            <div class="card-body">
                  <p style="text-align: center">Thank you for choosing Trioedu for your school administration. Please follow the steps to complete Trio Edu installation!</p>
