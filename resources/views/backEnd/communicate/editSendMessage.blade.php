...
@section('mainContent')
    ...
    <section class="admin-visitor-area up_admin_visitor">
        <div class="container-fluid p-0">
            ...
            {{ html()->form('POST', route('update-notice-data'))->class('form-horizontal')->open() }}
            <div class="row">
                <div class="col-lg-12">
                    <div class="white-box">
                        <div class="">
                                ...
                                <div class="col-lg-7">
                                    <div class="primary_input mb-30">
                                        ...
                                        <input
                                            ...
                                            value="{{ isset($noticeDataDetails) ? $noticeDataDetails->notice_title : '' }}">
                                    ...
                                    <div class="primary_input mt-0">
                                        <label class="primary_input_label" for="">@lang('communicate.notice') <span></span>
                                        </label>
                                        <textarea class="primary_input_field form-control" cols="0" rows="5" name="notice_message"
                                            id="notice_message">{!! isset($noticeDataDetails) ? $noticeDataDetails->notice_message : '' !!}</textarea>
                                    </div>
                                    <div class="primary_input mt-40">
                                        <input type="checkbox" id="is_published" class="common-checkbox" value="1"
                                            @if (@$noticeDataDetails->is_published == 1) checked @endif name="is_published">
                                                ...
                                                <div class="col">
                                                    <div class="">
                                                        <input
                                                            ...
                                                            name="notice_date"
                                                            value="{{ isset($noticeDataDetails) ? date('m/d/Y', strtotime($noticeDataDetails->notice_date)) : ' ' }}">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col">
                                                    <div class="">
                                                        <input
                                                            ...
                                                            name="publish_on"
                                                            value="{{ isset($noticeDataDetails) ? date('m/d/Y', strtotime($noticeDataDetails->publish_on)) : ' ' }}">
                                                    </div>
                                                </div>
                                                <button class="btn-date" data-id="#notice_date" type="button">
                                        ...
                                        @foreach ($roles as $role)
                                            <div class="">
                                                <input type="checkbox" id="role{{ $role->id }}"
                                                    class="common-checkbox" name="role[]" value="{{ $role->id }}"
                                                    {{ in_array($role->id, $inform_to != null ? $inform_to : []) ? 'checked' : '' }}>
