                                            ...
                                            <div class="col-md-12">
                                                ...
                                                @if ($input_field == 'service_charge')
                                                    ...
                                                    <div class="row {{ $d_none }}" id="charge_type_{{ $row->gateway_name }}">
                                                        ...
                                                        <div class="col-lg-6">
                                                            <div class="primary_input">
                                                                <input type="number"  class="primary_input_field form-control chargeValue {{ $errors->has('charge') ? ' is-invalid' : '' }}"     type="text" name="charge" data-gateway_name="{{ $row->gateway_name }}"    id="charge_{{ $row->gateway_name }}" autocomplete="off"   value="{{ $row->charge }}">
