            ...
            <div class="row">
                <div class="col-lg-6">
                    <div class="row">
                        <div class="col-lg-12">
                            @if($edit_data > 1)
                            {{ html()->form('PUT', route('custom-result-setting/update'))->attributes([
                            ...
                            @else
                                ...
                                {{ html()->form('POST', route('custom-result-setting/store'))->attributes([
                                    'class' => 'form-horizontal',
                                    'files' => true,
                                    'enctype' => 'multipart/form-data',
                                ])->open() }}
            ...
            <div class="row mt-40">
                <div class="col-lg-6">                    
                    <div class="white-box">
                        ...
                        {!! html()->form('POST', route('exam.step.skip.update'))->open() !!}
                            <div class="row">
                                <div class="col-lg-12">
