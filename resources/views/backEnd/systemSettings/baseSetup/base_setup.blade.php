        ...
        <div class="row">
            <div class="col-lg-3">
                <div class="row">
                    <div class="col-lg-12">
                        @if(isset($base_setup))
                        {{ html()->form('POST', route('base_setup_update'))->attributes([
                        ...
                        @else
                            @if(userPermission('base_setup_store'))
                            {{ html()->form('POST', route('base_setup_store'))->attributes([
                                'class' => 'form-horizontal',
                                'files' => true,
                                'enctype' => 'multipart/form-data',
                            ])->open() }}
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="mt-40 d-flex justify-content-between">
                    ...
                    {{ html()->form('POST', route('base_setup_delete'))->attribute('enctype', 'multipart/form-data')->open() }}
