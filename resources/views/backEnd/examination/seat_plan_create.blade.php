                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-2 mt-30-md" id="select_section_div">
                                <select
                                    ...
                                    @if (isset($section_id))
                                        <option value="" selected>@php$section = App\SmSection::select('section_name')
                                                ->where('id', $section_id)
                                                ->first();
                                ...
                                <select
                                    ...
                                    @if (isset($subject_id))
                                        <option value="" selected>@php
                                            $subject = App\SmSubject::select('subject_name')->where('id', $subject_id)->first();
                                ...
                                @if (count($seat_plan_assign_childs) == 0)
                                    <tr id="1">
                                        ...
                                        <td>{{ $students->count() }} <input type="hidden" name="total_student"
                                                id="total_student" value="{{ $students->count() }}"></td>
                                    ...
                                    @foreach ($seat_plan_assign_childs as $seat_plan_assign_child)
                                        ...
                                        <tr id="{{ $i }}">
                                            ...
                                            <td>{{ $i == 1 ? $students->count() : '' }} <input type="hidden"
                                                    name="total_student" id="total_student"
                                            ...
                                            @php
                                                $used_room = App\SmSeatPlanChild::usedRoomCapacity(
                                            ...
                                            <td class="text-right">
                                                <button class="primary-btn icon-only fix-gr-bg" type="button">
                                                    <span class="ti-trash text-white"
                                                        @if ($i != 1) onclick="deleteExamRow({{ $i }})" @endif "></span>
                                            </button>
                                        </td>
                                    </tr>
     @endforeach
