            ...
            <div class="row">
                ...
                <div class="col-lg-3">
                    <div class="row">
                        <div class="col-lg-12">
                            @if (isset($marks_grade))
                                {{ html()->form('PUT', route('marks-grade-update', $marks_grade->id))->attributes([
                            ...
                            @else
                                @if (userPermission('marks-grade-store'))
                                    {{ html()->form('POST', route('marks-grade-store'))->attributes([
                                            'class' => 'form-horizontal',
                                            'files' => true,
                                            'enctype' => 'multipart/form-data',
                                        ])->open() }}
                                ...
                                <div class="add-visitor">
                                    ...
                                    @if (generalSetting()->result_type != 'mark')
                                        <div class="row mt-15">
                                            <div class="col-lg-12">
                                                <div class="primary_input">
                                                    <label class="primary_input_label" for="">@lang('exam.gpa')
                                    ...
                                    <div class="row mt-15">
                                        <div class="col-lg-12">
                                            <div class="primary_input">
                                                <label class="primary_input_label" for="">@lang('exam.percent_from')<span
                                    ...
                                    <div class="row mt-15">
                                        <div class="col-lg-12">
                                            <div class="primary_input">
                                                <label class="primary_input_label" for="">@lang('exam.percent_to')<span
                                                        class="text-danger"> *</span></label>
                                                <input oninput="numberCheckWithDot(this)"
                                    ...
                                    @if (generalSetting()->result_type != 'mark')
                                            ...
                                            <div class="col-lg-12">
                                                <div class="primary_input">
                                                    <label class="primary_input_label"
                                                        for="">@lang('exam.gpa_from')<span class="text-danger">
                                                            *</span></label>
                                                    <input oninput="numberCheckWithDot(this)"
                                        ...
                                        <div class="row mt-15">
                                            <div class="col-lg-12">
                                                <div class="primary_input">
                                                    <label class="primary_input_label"
                                                        for="">@lang('exam.gpa_to')<span class="text-danger">
                                                            *</span></label>
                                                    <input oninput="numberCheckWithDot(this)"
                                                        class="primary_input_field form-control{{ $errors->has('grade_upto') ? ' is-invalid' : '' }}"
                                                        type="number" step="0.1" name="grade_upto"
                                                        autocomplete="off"
                                        ...
                                        <div class="col-lg-12">
                                            <div class="primary_input">
                                                <label class="primary_input_label" for="">@lang('common.description')
                                                    ...
                                                    @endif </label>
                                                <textarea class="primary_input_field form-control" cols="0" rows="4" name="description">{{ isset($marks_grade) ? $marks_grade->description : Request::old('description') }}</textarea>
                                        ...
                                        <tbody>
                                            ...
                                            @foreach ($marks_grades as $marks_grade)
                                                        ...
                                                        <x-drop-down>
                                                            @if (userPermission('marks-grade-edit'))
                                                                <a class="dropdown-item"
                                                                    href="{{ route('marks-grade-edit', [$marks_grade->id]) }}">@lang('common.edit')</a>
                                                            @endif
                                                ...
                                                <div class="modal fade admin-query"
                                                    id="deleteMarksGradeModal{{ @$marks_grade->id }}">
                                                        ...
                                                        <div class="modal-content">
                                                            ...
                                                            <div class="modal-body">
                                                                ...
                                                                <div class="mt-40 d-flex justify-content-between">
                                                                    ...
                                                                    {{ html()->form('DELETE', route('marks-grade-delete', $marks_grade->id))->attribute('enctype', 'multipart/form-data')->open() }}
