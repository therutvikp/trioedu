...
@section('mainContent')
    ...
    <section class="admin-visitor-area up_st_admin_visitor">
        <div class="container-fluid p-0">
            ...
            {{ html()->form('PUT', route('exam-update', $exam->id))->attributes([
                                        ...
                                        <div class="row mt-25">
                                                ...
                                                <select
                                                    ...
                                                    @foreach ($subjects as $subject)
                                                        <option value="{{ @$subject->subject_id }}"
                                                            {{ @$subject->subject_id == @$exam->subject_id ? 'selected' : '' }}>
                                            ...
                                            <div class="col-lg-4 mt-30-md">
                                                <select
                                                    class="primary_select form-control {{ $errors->has('class') ? ' is-invalid' : '' }}"
                                                    id="select_class" name="section" disabled="">
                                                    <option data-display="@lang('common.select_exam_type') *" value="">
                                                        @lang('common.select_exam_type') *</option>
                                                    @foreach ($exams_types as $exams_type)
                                                        <option value="{{ @$exams_type->id }}"
                                                            {{ @$exams_type->id == @$exam->exam_type_id ? 'selected' : '' }}>
                                                            {{ @$exams_type->title }}</option>
                                                    @endforeach
                                                </select>
                                                @if ($errors->has('class'))
                                                    <span class="text-danger invalid-select" role="alert">
                                            ...
                                            <div class="col-lg-4">
                                                <div class="primary_input">
                                                    <input oninput="numberMinZeroCheck(this)"
                                                        ...
                                                        type="text" name="pass_mark" id="pass_mark"
                                    ...
                                    <tbody>
                                        ...
                                        @foreach ($exam->GetExamSetup as $row)
                                            ...
                                            <tr id="row1" class="mt-40">
                                                <td class="border-top-0">
                                                    ...
                                                    <div class="primary_input">
                                                        ...
                                                        <input
                                                            ...
                                                            autocomplete="off" value="{{ @$row->exam_title }}">
                                                ...
                                                <td class="border-top">
                                                    <button class="primary-btn icon-only fix-gr-bg" id="firstMarkRow"
                                                        type="button" id="{{ $i != 1 ? 'removeMark' : '' }}">
                                        ...
                                        <tr>
                                            ...
                                            <td class="border-top-0" id="totalMark">
                                                <input type="text" class="primary_input_field form-control"
                                                    onkeypress="return isNumberKey(event)" name="totalMark"
                                                    readonly="true" value="{{ @$totalMark }}">
                                            </td>
