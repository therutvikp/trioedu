            ...
            <div class="row  mt-25">
                <div class="col-lg-12">
                    <div class="primary_input">
                        <input oninput="numberCheck(this)" class="primary_input_field form-control" type="text"
                            name="mark" autocomplete="off" value="{{ @$online_exam_question->mark }}" required>
            ...
            <div class="multiple-choice" id="multiple-choice">
                ...
                <div class="row  mt-25">
                    <div class="col-lg-10">
                        <div class="primary_input">
                            <input oninput="numberCheck(this)" class="primary_input_field form-control" type="text"
                                name="number_of_option" autocomplete="off" id="number_of_option_edit"
            ...
            <div class="multiple-options" id="multiple-options">
                ...
                @foreach ($multiple_options as $multiple_option)
                    ...
                    <div class='row  mt-25'>
                        <div class='col-lg-10'>
                            <div class='primary_input'>
                                <input class='primary_input_field form-control' type='text' name='option[]'
                                    autocomplete='off' required value="{{ @$multiple_option->title }}">
                                <label class="primary_input_label" for="">@lang('common.option')
                                    {{ $i }}</label>
                                <span class='focus-border'></span>
                            </div>
                        </div>
                        <div class='col-lg-2'>
                            <button type='button'><input type='checkbox' name='option_check_{{ $i }}'
                                    value='1' {{ @$multiple_option->status == 1 ? 'checked' : '' }}></button>
                        </div>
                    </div>
                @endforeach
