                                        ...
                                        <div class="col-lg-12">
                                            ...
                                            <div class="primary_input">
                                                <input type="checkbox" id="averageExam"
                                                    ...
                                                    {{ isset($exam_type_edit) ? ($exam_type_edit->is_average == 1 ? 'checked' : '') : Request::old('is_average') }}
                                                    {{ old('is_average') == 'yes' ? 'checked' : '' }}>
                                        ...
                                        <div class="col-lg-12">
                                            <div class="primary_input">
                                                ...
                                                <input
                                                    ...
                                                    value="{{ isset($exam_type_edit) ? $exam_type_edit->average_mark : Request::old('average_mark') }}">
                                                @error('average_mark')
