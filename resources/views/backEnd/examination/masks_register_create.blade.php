                                    ...
                                    <table class="table school-table-style" cellspacing="0" width="100%">
                                        ...
                                        <tbody>
                                            ...
                                            @foreach ($students as $record)
                                                @php
                                                    $absent_check = App\SmMarksRegister::un_is_absent_check(
                                                        $exam_id,
                                                        $request,
                                                        $subject_id,
                                                        $record->student_id,
                                    ...
                                    <div class="main-title">
                                        <h3 class="mb-15">@lang('exam.add_marks') |
                                            <small>@lang('exam.exam'): {{ $search_info['exam_name'] }}, @lang('common.class'):
                                                ...
                                                {{ $search_info['section_name'] }} @if(shiftEnable()) , @lang('common.shift'): {{ $search_info['shift_name'] }}@endif
                                        </h3>
                                    </div>
                                </div>
                            </div>
                                        ...
                                        <table class="table school-table-style add-marks-register-table" cellspacing="0"
                                            ...
                                            <thead class="text-nowrap">
                                                <tr>
                                                    <th rowspan="2">@lang('student.admission_no').</th>
                                                    <th rowspan="2">@lang('student.roll_no').</th>
                                                    <th rowspan="2"> @if(shiftEnable()) @lang('admin.class_Sec_shift') @else @lang('admin.class_Sec') @endif</th>
                                                    <th rowspan="2">@lang('common.student')</th>
                                                    <th class="text-center" colspan="{{ $number_of_exam_parts + 1 }}">
                                            ...
                                            <tbody>
                                                ...
                                                @foreach ($students as $record)
                                                    @php
                                                        $absent_check = App\SmMarksRegister::is_absent_check(
                                                            $exam_type->id,
                                                            $class_id,
                                                            $record->section_id,
                                                            $subject_id,
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>{{ $record->class->class_name . '(' . $record->section->section_name . ')' }} @if(shiftEnable()) [{{ @$record->shift->shift_name }}] @endif
                                                        </td>
                                                        <td>{{ $record->studentDetail->full_name }}</td>
                                                        @php $entry_form_count=0; @endphp
                                                        @foreach ($marks_entry_form as $part)
