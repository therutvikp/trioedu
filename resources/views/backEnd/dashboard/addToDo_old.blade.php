...
<div class="container-fluid">
    {{ html()->form('POST', route('saveToDoData'))->attributes([
                        ...
                        <div class="col">
                            <div class="primary_input">
                                <input
                                    ...
                                    id="startDate" type="text" autocomplete="off" readonly="true" name="date"
                                    value="{{ date('m/d/Y') }}">
                                <label class="primary_input_label" for="">@lang('common.date') <span></span>
                                </label>
                                @if ($errors->has('date'))
