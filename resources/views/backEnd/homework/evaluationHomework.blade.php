                                            ...
                                            <table id=""
                                                ...
                                                <tbody>
                                                    @foreach ($students as $value)
                                                        @php
                                                            $submitted_student = App\SmHomework::evaluationHomework(
                                                                $value->id,
                                                                $homeworkDetails->id,
                                                            );
                                                            @$uploadedContent = App\SmHomework::uploadedContent(
                                                                @$value->id,
                                                                $homeworkDetails->id,
                                                            );
                                                            $file_paths = [];
                                                            ...
                                                            @foreach ($fileList as $index => $file)
                                                                ...
                                                                <div class="mb-4">
                                                                    @if (in_array($ext, ['jpg', 'jpeg', 'png', 'heic']))
                                                                        <img class="img-responsive" style="width: 100%; height:auto" src="{{ $fileUrl }}">
                                                                    ...
                                                                    @elseif ($ext === 'mp3')
                                                                        <audio class="audio_play" controls style="width: 100%">
                                                                    ...
                                                                    <div class="mt-3 d-flex justify-content-between">
                                                                        <a class="primary-btn tr-bg" download href="{{ $fileUrl }}">
