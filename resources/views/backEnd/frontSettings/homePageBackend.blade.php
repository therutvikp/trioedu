                    ...
                    <div class="white-box">
                            ...
                            <div class="col-lg-6">
                                <div class="primary_input">
                                    ...
                                    <input class="primary_input_field form-control" type="text" name="title"
                                        autocomplete="off" value="{{ isset($links) ? @$links->title : '' }}">
                            ...
                            <div class="col-lg-6">
                                <div class="primary_input">
                                    ...
                                    <input class="primary_input_field form-control" type="text" name="long_title"
                                        autocomplete="off" value="{{ isset($links) ? @$links->long_title : '' }}">
                            ...
                            <div class="col-lg-12">
                                <div class="primary_input">
                                    ...
                                    <input class="primary_input_field form-control" type="text" name="short_description"
                                        autocomplete="off" value="{{ isset($links) ? @$links->short_description : '' }}">
                        ...
                        <div class="row mt-15">
                            ...
                            <div class="col-lg-4 mt-40">
                                <img src="{{ isset($links) ? @$links->image : '' }}" style="width: 100%; height: auto;"
