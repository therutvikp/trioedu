                ...
                <div class="row">
                    <div class="col-lg-12">
                        @if (isset($add_front_exam_routine))
                            {{ html()->form('POST', route('front-exam-routine-update'))->attributes([
                        ...
                        @else
                            @if (userPermission('front-exam-routine-store'))
                                {{ html()->form('POST', route('front-exam-routine-store'))->attributes([
                                        'class' => 'form-horizontal',
                                        'files' => true,
                                        'enctype' => 'multipart/form-data',
                                    ])->open() }}
                                        ...
                                        <div class="primary_input">
                                            ...
                                            <div class="primary_file_uploader">
                                                <input
                                                    ...
                                                    placeholder="{{ isset($add_front_exam_routine) ? (@$add_front_exam_routine->result_file != '' ? getFilePath3(@$add_front_exam_routine->result_file) : trans('front_settings.routine_file') . ' *') : trans('front_settings.routine_file') . ' *' }}"
