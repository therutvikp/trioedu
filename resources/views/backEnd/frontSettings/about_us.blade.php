                            ...
                            <div class="white-box">
                                ...
                                <div class="add-visitor {{ isset($update) ? '' : 'isDisabled' }}">
                                        ...
                                        <div class="col-lg-12">
                                            ...
                                            <div class="primary_input mt-15">
                                                <div class="primary_input">
                                                    ...
                                                    <textarea class="generated-text primary_input_field form-control" cols="0" rows="5" name="description"
                                                        id="description">{{ isset($update) ? ($about_us != '' ? $about_us->description : '') : '' }}</textarea>
                                            ...
                                            <div class="primary_input mt-15">
                                                <div class="primary_input">
                                                    ...
                                                    <textarea class="primary_input_field form-control" cols="0" rows="5" name="main_description"
                                                        id="main_description">{{ isset($update) ? ($about_us != '' ? $about_us->main_description : '') : '' }}</textarea>
                                    ...
                                    <div class="row  mt-15">
                                        ...
                                        <div class="col-lg-12">
                                            <div class="primary_input">
                                                <label class="primary_input_label"> {{ __('front_settings.image') }} <span
                                                        class="text-danger"> *</span></label>
                                    ...
                                    <div class="row  mt-15">
                                        ...
                                        <div class="col-lg-12">
                                            <div class="primary_input">
                                                <label class="primary_input_label"> {{ __('front_settings.main_image') }}
                                                    <span class="text-danger"> *</span></label>
                                                <div class="primary_file_uploader">
                                                    <input
                                                        class="primary_input_field form-control{{ $errors->has('main_image') ? ' is-invalid' : '' }}"
                                                        id="placeholderPhoto" type="text"
                                            ...
                                            @if (Illuminate\Support\Facades\Config::get('app.app_sync'))
                                                <span class="d-inline-block" tabindex="0" data-toggle="tooltip"
                                                    title="Disabled For Demo "> <button
                                                        ...
                                                        style="pointer-events: none;" type="button">@lang('front_settings.update')
                                                    </button></span>
                                            @else
                                                    ...
                                                    @if ($about_us != '')
                                                        ...
                                                        @if (userPermission('about-page/edit'))
                                                            <a href="{{ route('about-page/edit') }}"
                                                                class="primary-btn small fix-gr-bg">@lang('common.edit')</a>
                                                        @endif
                                                    @endif
                                                </td>
                                            </tr>
                                    ...
                                    <div class="mt-20">
                                        <section class="container box-1420">
                                            <div class="banner-area"
                                                style="background: linear-gradient(0deg, rgba(124, 50, 255, 0.6), rgba(199, 56, 216, 0.6)), url({{ $about_us->image != '' ? $about_us->image : '../img/client/common-banner1.jpg' }}) no-repeat center;background-size: cover">
                                                <div class="banner-inner">
                                                    <div class="banner-content">
                                                        ...
                                                        <a class="primary-btn fix-gr-bg semi-large"
                                                            href="{{ $about_us->button_url }}">{{ $about_us->button_text }}</a>
                                                    </div>
                                                </div>
                                            </div>
                                        </section>
                                            ...
                                            <div class="col-md-6">
                                                <div class="academic-item">
                                                    <div class="academic-img">
                                                        <img class="img-fluid" src="{{ asset($about_us->main_image) }}"
                                                            alt="">
                                                    </div>
                                                </div>
                                            </div>
