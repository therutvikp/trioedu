                                                        ...
                                                        <x-drop-down>
                                                            @if (userPermission('view-page'))
                                                                <a class="dropdown-item"
                                                                    href="{{ route('view-page', ['slug' => @$page->slug]) }}">@lang('front_settings.preview')</a>
                                                            @endif

                                                            @if (userPermission('edit-page'))
                                                                <a class="dropdown-item"
                                                                    href="{{ route('edit-page', [@$page->id]) }}">@lang('common.edit')</a>
                                                            @endif

                                                            @if (userPermission('delete-page'))
                                                                <a class="dropdown-item" data-toggle="modal"
                                                                    data-target="#deletePages{{ @$page->id }}"
                                                                    href="#">
                                                                    @lang('common.delete')
                                                                </a>
                                                            @endif
                                                            ...
                                                            @if (@$page->header_image)
                                                                @if (userPermission('download-page'))
                                                                    <a class="dropdown-item"
                                                                        href="{{ url(@$page->header_image) }}" download>
                                                        ...
                                                        <div class="modal-content">
                                                            ...
                                                            <div class="modal-body">
                                                                ...
                                                                <div class="mt-40 d-flex justify-content-between">
                                                                    ...
                                                                    {{ html()->form('POST', route('delete-page', @$page->id))->open() }}
