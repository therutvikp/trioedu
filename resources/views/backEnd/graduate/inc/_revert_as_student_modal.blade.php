<div class="modal-body">
    @if (isset($graduate))
        {{ html()->form('POST', route('alumni.revert-as-student'))->class('form-horizontal')->open() }}
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="primary_input mt-2 pt-1 mb-20 text-center">
                            ...
                            <p class="text-danger">Are you sure you want to revert this graduated student back to their
                                status as a regular student ?</p>
                        </div>
                    </div>
                </div>
            </div>
