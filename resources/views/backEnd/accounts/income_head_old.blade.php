                ...
                <div class="col-lg-3">
                    <div class="row">
                        <div class="col-lg-12">
                            ...
                            @if (isset($income_head))
                                {{ html()->form('POST', route('income_head_update'))->attributes([
                                        'class' => 'form-horizontal',
                                        'files' => true,
                                        'enctype' => 'multipart/form-data',
                                    ])->open() }}
                            @else
                                {{ html()->form('POST', route('income_head_store'))->attributes([
                                        'class' => 'form-horizontal',
                                        'files' => true,
                                        'enctype' => 'multipart/form-data',
                                    ])->open() }}
                            ...
                            <div class="white-box">
                                <div class="add-visitor">
                                    <div class="row  mt-25">
                                        <div class="col-lg-12">
                                            ...
                                            <div class="primary_input">
                                                <input
                                                    class="primary_input_field form-control{{ @$errors->has('income_head') ? ' is-invalid' : '' }}"
                                                    type="text" name="income_head" autocomplete="off"
                                                    value="{{ isset($income_head) ? $income_head->name : '' }}">
                                                <input type="hidden" name="id"
                                                    value="{{ isset($income_head) ? $income_head->id : '' }}">
                                    ...
                                    <div class="row mt-25">
                                        <div class="col-lg-12">
                                            <div class="primary_input">
                                                <textarea class="primary_input_field" cols="0" rows="4" name="description">{{ isset($income_head) ? $income_head->description : '' }}</textarea>
                                ...
                                <tbody>
                                    @foreach ($income_heads as $income_head)
                                                ...
                                                <div class="dropdown">
                                                    ...
                                                    <div class="dropdown-menu dropdown-menu-right">
                                                        <a class="dropdown-item"
                                                            href="{{ route('income_head_edit', [@$income_head->id]) }}">edit</a>
                                                        <a class="dropdown-item" data-toggle="modal"
                                                            data-target="#deleteIncomeHeadModal{{ @$income_head->id }}"
                                        ...
                                        <div class="modal fade admin-query"
                                            id="deleteIncomeHeadModal{{ @$income_head->id }}">
                                                ...
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-body">
                                                        ...
                                                        <div class="mt-40 d-flex justify-content-between">
                                                            ...
                                                            <a href="{{ route('income_head_delete', [@$income_head->id]) }}"
                                                                class="text-light">
                                                                <button class="primary-btn fix-gr-bg"
