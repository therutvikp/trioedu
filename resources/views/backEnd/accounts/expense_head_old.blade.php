                ...
                <div class="col-lg-3">
                    <div class="row">
                        <div class="col-lg-12">
                            ...
                            @if (isset($expense_head))
                                {{ html()->form('PUT', url('expense-head/' . @$expense_head->id))->attributes([
                                        'class' => 'form-horizontal',
                                        'files' => true,
                                        'enctype' => 'multipart/form-data',
                                    ])->open() }}
                            @else
                                {{ html()->form('POST', url('expense-head'))->attributes([
                                        'class' => 'form-horizontal',
                                        'files' => true,
                                        'enctype' => 'multipart/form-data',
                                    ])->open() }}
                            ...
                            <div class="white-box">
                                <div class="add-visitor">
                                        ...
                                        <div class="col-lg-12">
                                            ...
                                            <div class="primary_input">
                                                <input
                                                    ...
                                                    value="{{ isset($expense_head) ? $expense_head->name : '' }}">
                                    ...
                                    <div class="row mt-25">
                                        <div class="col-lg-12">
                                            <div class="primary_input">
                                                <textarea class="primary_input_field" cols="0" rows="4" name="description">{{ isset($expense_head) ? $expense_head->description : '' }}</textarea>
                                ...
                                <tbody>
                                    @foreach ($expense_heads as $expense_head)
                                                ...
                                                <div class="dropdown">
                                                    ...
                                                    <div class="dropdown-menu dropdown-menu-right">
                                                        <a class="dropdown-item"
                                                            href="{{ url('expense-head', [@$expense_head->id]) }}">edit</a>
                                                        <a class="dropdown-item" data-toggle="modal"
                                                            data-target="#deleteExpenseHeadModal{{ @$expense_head->id }}"
                                        ...
                                        <div class="modal fade admin-query"
                                            id="deleteExpenseHeadModal{{ @$expense_head->id }}">
                                                ...
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-body">
                                                        ...
                                                        <div class="mt-40 d-flex justify-content-between">
                                                            ...
                                                            {{ html()->form('DELETE', url('expense-head/' . @$expense_head->id))->attribute('enctype', 'multipart/form-data')->open() }}
                                                            <button class="primary-btn fix-gr-bg"
