            ...
            <div class="row">
                <div class="col-lg-3">
                    <div class="row">
                        <div class="col-lg-12">
                            @if (isset($editData))
                                {{ html()->form('PUT', route('event-update', $editData->id))->attributes([
                            ...
                            @else
                                @if (userPermission('event-store'))
                                    {{ html()->form('POST', route('event'))->attributes([
                                            'class' => 'form-horizontal',
                                            'enctype' => 'multipart/form-data',
                                            'files' => true,
                                        ])->open() }}
                            ...
                            <div class="white-box">
                                ...
                                <div class="add-visitor">
                                    <div class="row">
                                        <div class="col-lg-12 mb-15">
                                            <div class="primary_input">
                                                <label class="primary_input_label" for="">@lang('communicate.event_title') <span
                                                        class="text-danger"> *</span> </label>
                                                <input
                                                    class="primary_input_field form-control{{ $errors->has('event_title') ? ' is-invalid' : '' }}"
                                        ...
                                        <div class="col-lg-12 mb-15">
                                            ...
                                            <select multiple id="selectMultiUsers"
                                                class="multypol_check_select active position-relative" name="role_ids[]"
                                                style="width:300px">

                                                @foreach ($roles as $role)
                                                    <option value="{{ $role->id }}"
                                                        {{ @$editData && $editData->role_ids ? (in_array($role->id, json_decode($editData->role_ids)) ? 'selected' : '') : '' }}>
                                                        {{ $role->name }}</option>
                                                @endforeach
                                            </select>
                                            @error('role_ids')
                                        ...
                                        <div class="col-lg-12 mb-15">
                                            <div class="primary_input">
                                                <label class="primary_input_label" for="">@lang('communicate.event_location') <span
                                                        class="text-danger"> *</span> </label>
                                                <input
                                                    class="primary_input_field form-control{{ $errors->has('event_location') ? ' is-invalid' : '' }}"
                                    ...
                                    <div class="row mb-15">
                                        <div class="col-lg-12">
                                            <div class="primary_input">
                                                <label class="primary_input_label" for="">@lang('communicate.to_date')<span
                                                        class="text-danger"> *</span> </label>
                                                <div class="primary_datepicker_input">
                                                    <div class="no-gutters input-right-icon">
                                                        <div class="col">
                                        ...
                                        <div class="col-lg-12">
                                            <div class="primary_input">
                                                <label class="primary_input_label" for="">@lang('common.description') <span
                                                        class="text-danger"> *</span> </label>
                                                <textarea class="primary_input_field form-control {{ $errors->has('event_des') ? ' is-invalid' : '' }}"
                                                    cols="0" rows="4" name="event_des">{{ isset($editData) ? $editData->event_des : old('event_des') }}</textarea>
                                                @error('event_des')
                                                    <span class="text-danger">
                                                        {{ $message }}
                                                    </span>
                                    ...
                                    <div class="row mb-15">
                                        <div class="col-lg-12">
                                            <div class="primary_input">
                                                <label class="primary_input_label"
                                                    for="">@lang('common.url')</label>
                                                <textarea class="primary_input_field form-control {{ $errors->has('url') ? ' is-invalid' : '' }}" cols="0"
                                                    rows="4" name="url">{{ isset($editData) ? $editData->url : old('url') }}</textarea>
                                                @error('url')
                                    ...
                                    <table id="eventDataTable" class="table" cellspacing="0" width="100%">
                                        <thead>
                                            <tr>
                                                ...
                                                <th class="not-export-col">@lang('common.action')</th>
                                            </tr>
                                        </thead>
                                    </table>
                                </x-table>
