            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="white-box">
                        ...
                        @if (isset($v_custom_field) && userPermission('edit-custom-field'))
                          
                            {{ html()->form('POST', route('update-student-registration-custom-field'))->class('form-horizontal')->open() }}
                                <input type="hidden" name="id" value="{{ $v_custom_field->id }}">
                          
                        @else
                            @if(userPermission('store-student-registration-custom-field'))
                                {{ html()->form('POST', route('store-student-registration-custom-field'))->class('form-horizontal')->open() }}
                            @endif
                        @endif
                            @include('backEnd.customField._custom_form', ['type' => 'student_online_regi'])
                        @if(userPermission('store-student-registration-custom-field') || userPermission('edit-custom-field'))
                            {{ html()->form()->close() }}
                        @endif
                    </div>
                </div>
                                        ...
                                        <tbody>
                                            @foreach ($custom_fields as $key => $custom_field)
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <x-drop-down>
                                                            @if (userPermission('edit-custom-field'))
                                                                <a class="dropdown-item"
                                                                    href="{{ route('edit-custom-field', ['id' => @$custom_field->id]) }}">@lang('common.edit')</a>
                                                            @endif
                                                            @if (userPermission('delete-custom-field'))
                                                        ...
                                                        <div class="modal-content">
                                                            ...
                                                            <div class="modal-body">
                                                                ...
                                                                <div class="mt-40 d-flex justify-content-between">
                                                                    ...
                                                                    {{ html()->form('POST', route('delete-custom-field'))->open() }}
