        ...
        <div class="container-fluid p-0">
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="white-box">
                        @if (isset($v_custom_field))
                            {{ html()->form('POST', route('update-donor-custom-field'))->class('form-horizontal')->open() }}
                            <input type="hidden" name="id" value="{{ $v_custom_field->id }}">
                        @else
                            {{ html()->form('POST', route('store-donor-registration-custom-field'))->class('form-horizontal')->open() }}
                        @endif
                                                    ...
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-body">
                                                            ...
                                                            <div class="mt-40 d-flex justify-content-between">
                                                                ...
                                                                {{ html()->form('POST', route('delete-donor-custom-field'))->open() }}
