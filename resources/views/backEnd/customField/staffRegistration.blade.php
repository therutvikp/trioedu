            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="white-box">
                        ...
                        @if (isset($v_custom_field))
                            {{ html()->form('POST', route('update-staff-custom-field'))->class('form-horizontal')->open() }}
                            <input type="hidden" name="id" value="{{ $v_custom_field->id }}">
                        @else
                            {{ html()->form('POST', route('store-staff-registration-custom-field'))->class('form-horizontal')->open() }}
                        @endif
                                                            ...
                                                            <div class="dropdown-menu dropdown-menu-right">
                                                                @if (userPermission('edit-staff-custom-field'))
                                                                    <a class="dropdown-item"
                                                                        href="{{ route('edit-staff-custom-field', ['id' => @$custom_field->id]) }}">@lang('common.edit')</a>
                                                                @endif
                                                        ...
                                                        <div class="modal-content">
                                                            ...
                                                            <div class="modal-body">
                                                                ...
                                                                <div class="mt-40 d-flex justify-content-between">
                                                                    ...
                                                                    {{ html()->form('POST', route('delete-staff-custom-field'))->open() }}
