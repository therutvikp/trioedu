...
@section('mainContent')
    ...
    <section class="admin-visitor-area up_admin_visitor">
        <div class="container-fluid p-0">
            ...
            {{ html()->form('POST', route('print-generate-certificate'))->class('form-horizontal')->open() }}
            <div class="row">
                <div class="col-lg-12">
                    <div class="white-box">
                        <div class="row">
                            ...
                            <div class="col-lg-4 mt-30-md systemRole">
                                <select
                                    class="primary_select new_test w-100 bb form-control {{ @$errors->has('role') ? ' is-invalid' : '' }}"
                                    name="certificate_role" id="certificateRole">
                            ...
                            @else
                                <div class="col-lg-2 mt-30-md classSection d-none">
                                    <select
                                        class="primary_select new_test w-100 bb form-control {{ @$errors->has('class') ? ' is-invalid' : '' }}"
                            ...
                            <div class="col-lg-4 mt-30-md" id="certificate-div">
                                <select
                                    ...
                                    <option data-display=" @lang('admin.certificate') *" value=""> @lang('admin.certificate') *
                                    </option>
                                </select>
