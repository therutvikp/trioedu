                                ...
                                <tbody>
                                    @foreach ($certificates as $key => $certificate)
                                        <tr>
                                            ...
                                            <td>{{ @$certificate->roleName->name ? $certificate->roleName->name : trans('common.student') }}
                                            </td>
                                            <td>
                                                <a class="text-color"
                                                    href="{{ route('view-certificate', $certificate->id) }}"
                                            ...
                                            <td>
                                                ...
                                                <a class="dropdown-item" data-toggle="modal"
                                                    data-target="#deleteCertificate{{ $certificate->id }}"
                            ...
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    ...
                                    <div class="mt-40 d-flex justify-content-between">
                                        ...
                                        {{ html()->form('POST', route('student-certificate-delete'))->open() }}
