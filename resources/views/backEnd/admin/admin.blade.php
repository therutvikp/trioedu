                ...
                <div class="col-lg-3">
                    <div class="row">
                        <div class="col-lg-12">
                            ...
                            @if (isset($section))
                                {{ html()->form('POST', route('section_update'))->attributes([
                                        'class' => 'form-horizontal',
                                        'files' => true,
                                        'enctype' => 'multipart/form-data',
                                    ])->open() }}
                            @else
                                {{ html()->form('POST', route('section_store'))->attributes([
                                        'class' => 'form-horizontal',
                                        'files' => true,
                                        'enctype' => 'multipart/form-data',
                                    ])->open() }}
                        ...
                        <div class="modal-dialog">
                            ...
                            <div class="modal-content modalContent">
                                ...
                                <div class="modal-footer compareFooter deleteButtonDiv">
                                    <button type="button" class="modalbtn btn-primary"><a
                                            href="{{ route('section_delete', [@$section->id]) }}"
                                            class="text-light">@lang('academics.yes')</a></button>
                                    <button type="button" class="modalbtn btn-danger"
                                        data-dismiss="modal">@lang('academics.no')</button>
                                </div>
                            </div>
