                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="white-box">
                            ...
                            {{ html()->form('GET', route('payroll'))->attributes([
                                                        ...
                                                        <x-drop-down>
                                                            @if (!empty($getPayrollDetails))
                                                                ...
                                                                @if($getPayrollDetails->payrollPayments)
                                                                    <a class="dropdown-item modalLink" title="View Payroll Payment"  data-modal-size="modal-xl"  href="{{ route('view-payroll-payment', $getPayrollDetails->id) }}">
                                                                        @lang('hr.view Payment')
                                                                    </a>
