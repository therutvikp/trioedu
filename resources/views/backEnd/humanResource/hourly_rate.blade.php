            ...
            <div class="col-lg-3">
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        @if(isset($hourly_rate))
                        {{ html()->form('PUT', route('hourly-rate-update', $hourly_rate->id))->attributes([
                                'class' => 'form-horizontal',
                                'files' => true,
                                'enctype' => 'multipart/form-data',
                            ])->open() }}
                        @else
                        {{ html()->form('POST', route('hourly-rate'))->attributes([
                                'class' => 'form-horizontal',
                                'files' => true,
                                'enctype' => 'multipart/form-data',
                            ])->open() }}
                                        ...
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                ...
                                                <div class="mt-40 d-flex justify-content-between">
                                                    ...
                                                    {{ html()->form('DELETE', route('hourly-rate-delete', $hourly_rate->id))->attribute('enctype', 'multipart/form-data')->open() }}
