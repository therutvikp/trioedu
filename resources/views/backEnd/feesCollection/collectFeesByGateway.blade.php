...
@section('mainContent')
    ...
    <section class="admin-visitor-area">
        <div class="container-fluid p-0">
            ...
            {{ html()->form('POST', route('payByPaypal'))->attributes([
                            ...
                            <div class="row justify-content-center mb-30">
                                <div class="col-lg-4">
                                    <div class="primary_input">
                                        <input
                                            class="primary_input_field form-control{{ $errors->has('from_name') ? ' is-invalid' : '' }}"
                                            type="text" name="amount" id="amount" autocomplete="off"
                                            value="{{ isset($amount) ? $amount : '' }}" readonly="readonly">
                                        <label class="primary_input_label" for="">@lang('fees.fees_amount') <span
