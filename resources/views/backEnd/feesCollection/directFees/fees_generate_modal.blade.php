...
<div class="container-fluid">
    {{ html()->form('POST', route('fees-payment-store'))->attributes([
        ...
        <div class="col-lg-12">
            ...
            @if (moduleStatusCheck('University'))
                <input type="hidden" name="real_amount" id="real_amount"
                    value="{{ discountFeesAmount($installment_id) }}">
            @elseif(directFees())
                ...
                <div class="col-lg-12" id="sibling_class_div">
                    <div class="primary_input">
                        <label class="primary_input_label" for="">@lang('fees.amount') <span class="text-danger">
                                *</span> </label>
                        @if (moduleStatusCheck('University'))
                            <input oninput="numberMinZeroCheck(this)" class="primary_input_field form-control"
                                type="text" max="{{ discountFeesAmount($installment_id) }}" name="amount"
                                value="{{ discountFeesAmount($installment_id) }}" id="amount" required>
                        @elseif(directFees())
                            <input oninput="numberMinZeroCheck(this)" class="primary_input_field form-control"
                                type="text" max="{{ $balace_amount }}" name="amount" value="{{ $balace_amount }}"
                                id="amount" required>
                        @endif
                ...
                <div class="col-lg-6 d-none">
                    <div class="primary_input">
                        ...
                        <input oninput="numberCheckWithDot(this)" class="primary_input_field form-control"
                            type="text" name="discount_amount" id="discount_amount" value="0">
                    ...
                    <div class="d-flex radio-btn-flex ml-40">
                        <div class="mr-30">
                            <input type="radio" name="payment_mode" id="cash" value="cash"
                                class="common-radio relationButton" onclick="relationButton('cash')" checked>
            ...
            <div class="row mt-50" id="feesBankPayment">
                ...
                <div class="col-lg-9">
                    <div class="primary_input">
                        <select class="primary_select{{ $errors->has('bank_id') ? ' is-invalid' : '' }}"
                            name="bank_id">
                            @if (isset($banks))
