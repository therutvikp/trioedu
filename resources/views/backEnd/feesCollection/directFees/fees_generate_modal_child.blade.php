...
<div class="container-fluid">
    {{ html()->form('POST', route('child-bank-slip-store'))->attributes([
        ...
        <div class="col-lg-12">
            ...
            <div class="row mt-25">
                            ...
                            <div class="col">
                                <div class="primary_input">
                                    ...
                                    <input
                                        ...
                                        id="startDate" type="text" name="date" value="{{ date('m/d/Y') }}"
                                        readonly>
                                    <button class="btn-date" style="top: 70% !important;" data-id="#date_of_birth"
                                        type="button">
                ...
                <div class="col-lg-6" id="sibling_class_div">
                    <div class="primary_input">
                        <label class="primary_input_label" for="">@lang('fees.amount') <span class="text-danger">
                                *</span> </label>
                        <input class="primary_input_field form-control read-only-input has-content" type="number"
                            name="amount" value="{{ $balance_fees }}" id="amount" required>
            ...
            <div class="row mt-25" id="fine_title" style="display:none">
                <div class="col-lg-12">
                    <div class="primary_input">
                        <label class="primary_input_label" for="">@lang('fees.fine_title') <span class="text-danger">
                                *</span> </label>
            ...
            <div class="row mt-50">
                ...
                <div class="col-lg-6">
                    <div class="d-flex radio-btn-flex ml-40">
                        @if (@$method['bank_info']->active_status == 1)
                            <div class="mr-30">
                                <input type="radio" name="payment_mode" id="cash" value="bank"
                                    class="common-radio relationButton" onclick="relationButton('Bk')"
                                    {{ @$method['bank_info']->active_status == 1 ? 'checked' : '' }}>
                        ...
                        @if (@$method['cheque_info']->active_status == 1)
                            <div class="mr-30">
                                <input type="radio" name="payment_mode" id="cheque" value="cheque"
                                    class="common-radio relationButton" onclick="relationButton('Cq')"
                                    {{ @$method['bank_info']->active_status != 1 ? 'checked' : '' }}>
                        ...
                        @if (directFees())
                            @if (@$data['PayPal']->active_status == 1)
                                <div class="mr-30">
                                    <input type="radio" name="payment_mode" id="Paypal" value="PayPal"
                                        class="common-radio relationButton" onclick="relationButton('PayPal')">
                            ...
                            @if (@$data['Stripe']->active_status == 1)
                                <div class="mr-30">
                                    <input type="radio" name="payment_mode" id="Stripe" value="Stripe"
                                        class="common-radio relationButton" onclick="relationButton('Stripe')">
                            ...
                            @if (@$data['Paystack']->active_status == 1)
                                <div class="mr-30">
                                    <input type="radio" name="payment_mode" id="Paystack" value="Paystack"
                                        class="common-radio relationButton" onclick="relationButton('Paystack')">
                            ...
                            @if (@$data['CcAveune']->active_status == 1)
                                <div class="mr-30">
                                    <input type="radio" name="payment_mode" id="CcAveune" value="CcAveune"
                                        class="common-radio relationButton" onclick="relationButton('CcAveune')">
                            ...
                            @if (@$data['PhonePe']->active_status == 1)
                                <div class="mr-30">
                                    <input type="radio" name="payment_mode" id="PhonePe" value="PhonePe"
                                        class="common-radio relationButton" onclick="relationButton('PhonePe')">
            ...
            <div class="row mt-50" id="feesBankPayment">
                ...
                <div class="col-lg-9">
                    <div class="primary_input">
                        <select
                            class="primary_select form-control bb{{ $errors->has('bank_id') ? ' is-invalid' : '' }}"
                            name="bank_id">
                            @if (isset($banks))
                    ...
                    <div class="col-lg-6 mt-20">
                        <div class="primary_input">
                            ...
                            <input
                                ...
                                type="text" name="name_on_card" autocomplete="off" value="">
                            @if ($errors->has('name_on_card'))
                                <span class="text-danger" role="alert"> {{ $errors->first('name_on_card') }}</span>
                            @endif
                        </div>
                    </div>
                    <div class="col-lg-6 mt-20">
                        <div class="primary_input">
                            ...
                            <input
                                ...
                                type="text" name="card-number" autocomplete="off" value="">


                            @if ($errors->has('card-number'))
                                <span class="text-danger" role="alert"> {{ $errors->first('card-number') }}</span>
                            @endif
                        </div>
                    </div>
                </div>
                    ...
                    <div class="col-lg-4 mt-20">
                        <div class="primary_input">
                            ...
                            @if ($errors->has('card-cvc'))
                                <span class="text-danger" role="alert"> {{ $errors->first('card-cvc') }}</span>
                            @endif
                        </div>
                    </div>
                    <div class="col-lg-4 mt-20">
                        <div class="primary_input">
                            ...
                            <input class="primary_input_field form-control card-expiry-month" type="text"
                                name="card-expiry-month" autocomplete="off" value="">
                    ...
                    <div class="col-lg-4 mt-20">
                        <div class="primary_input">
                            ...
                            <input class="primary_input_field form-control card-expiry-year" type="text"
                                name="card-expiry-year" autocomplete="off" value="">
        ...
        $.ajax({
            ...
            success: function(data) {
                if (data.service_charge) {
                    ...
                    $('#serviceChargeArea').html('You Have to Pay service charge ' + data.service_charge +
                        ' for ' + gateway + ' per transaction' + '. ' +
                        'Your payable amount with serivce charge : ' + symbol + amount + '+' + symbol +
                        data.service_charge_amount + ' = ' + symbol + parseFloat(total));
                } else {
                    $("#serviceChargeArea").hide();
                }
            },
