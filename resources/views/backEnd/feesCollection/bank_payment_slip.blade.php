                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-3 col-md-3 mt-15">
                                    ...
                                    <select
                                        ...
                                        <option value="0"
                                            {{ isset($approve_status) ? ($approve_status == 0 ? 'selected' : '') : '' }}>
                                            @lang('common.pending')</option>
                                        <option value="1"
                                            {{ isset($approve_status) ? ($approve_status == 1 ? 'selected' : '') : '' }}>
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-3 col-md-3 ">
                                    ...
                                    <select
                                        class="primary_select  form-control{{ $errors->has('approve_status') ? ' is-invalid' : '' }}"
                                        name="approve_status">
                                        <option data-display="@lang('common.status')" value="">@lang('common.status')
                                        </option>
                                        <option value="0"
                                            {{ isset($approve_status) ? ($approve_status == 0 ? 'selected' : '') : '' }}>
                                            @lang('common.pending')</option>
