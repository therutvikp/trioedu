...
<style>
    ...
    .table.school-table-style tbody .common-checkbox~label::before,
    .table.school-table-style tbody.common-checkbox~label::after{
        left: 6px!important;
    }

    .table.school-table-style .common-checkbox:checked~label::before,
    .table.school-table-style .common-checkbox:checked~label::after{
        left: 6px!important;
    }

    .table.school-table-style tbody tr td{
        vertical-align: middle!important
    }

    .table.school-table-style tbody tr td h5{
        margin-bottom: 0;
    }
            ...
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <div class="row">
                        ...
                        {{ html()->form('GET', route('student-current-search'))->attributes([
                            ...
                            <div class="row">
                                ...
                                {{-- @if(shiftEnable())
                                @includeIf('backEnd.shift.shift_class_section_include', [
                                    'grid_class' => 'col-lg-3',
                                    'mt' => 'mt-30-md',
                                    ...
                                    <select class="primary_select  form-control{{ $errors->has('current_section') ? ' is-invalid' : '' }}" id="sectionSelectStudent"  name="current_section">
                                       ...
                                       @isset($sections) 
                                        @foreach($sections as $section)
                                         <option  value="{{$section->sectionName !='' ?  $section->sectionName->id : ''}}" {{isset($section_id)? ($section_id == ($section->sectionName !='' ? $section->sectionName->id :'')? 'selected':''):''}} >{{$section->sectionName->section_name}}</option>
                                         @endforeach
                                       @endisset
                                    </select>
        ...
        <div class="container-fluid p-0">
            <div class="row mt-40 white-box">
                <div class="col-lg-12">
                            ...
                            <div class="main-title">
                                <h3 class="mb-30">@lang('student.promote') | 
                                    <small>
                                        ...
                                        @if(shiftEnable()) @lang('admin.shift'): {{$search_current_shift !='' ? $search_current_shift->name : ' '}}, @endif
                    ...
                    <input type="hidden" name="pre_class" value="{{ isset($class_id) ? $class_id:''}}">
                    <input type="hidden" name="pre_section" value="{{ isset($section_id) ? $section_id:''}}">
                    <input type="hidden" name="pre_shift" value="{{ isset($shift_id) ? $shift_id:''}}">
                                ...
                                <table class="table school-table-style" cellspacing="0" width="100%">
                                    <thead>
                                        <tr>
                                            ...
                                            @endif      
                                            @if(shiftEnable())                   
                                            <th class="class_datas">@lang('student.promote_shift')</th> 
                                            @endif
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td class="class_datas">
                                                <div class="row">
                                                    <div class="col-lg-12">
                                                        <select class="primary_select form-control{{ $errors->has('shift') ? ' is-invalid' : '' }} promote_shift"  name="promote[{{$student->id}}][shift]">
                                                            <option data-display="@lang('admin.select_shift') *" value="">@lang('admin.select_shift') *
                                                            </option>
