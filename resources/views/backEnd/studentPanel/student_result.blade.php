                ...
                @foreach ($records as $key => $record)
                    <li class="nav-item">
                        <a class="nav-link @if ($record->is_default == 1) active @endif " href="#tab{{ $key }}" role="tab"
                            data-toggle="tab">{{ $record->class->class_name }} ({{ $record->section->section_name }}) @if(shiftEnable()) @if($record->shift) [{{@$record->shift->shift_name}}]  @endif @endif </a>
                    </li>
                @endforeach
                                                    ...
                                                    <x-table>
                                                        <table id="" class="table mb-5" cellspacing="0"
                                                            ...
                                                            <tfoot>
                                                                <tr>
                                                                    <th></th>
                                                                    <th>@lang('exam.position'): {{getStudentMeritPosition($record->class_id, $record->section_id, $exam->id, $record->id, $record->shift_id)}}</th>
                                                                    <th>
