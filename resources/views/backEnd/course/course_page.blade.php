                            ...
                            <div class="add-visitor">
                                <div class="row">
                                    ...
                                    <div class="col-lg-6">
                                        <div class="primary_input">
                                            <select
                                                class="primary_select  form-control{{ $errors->has('category_id') ? ' is-invalid' : '' }} mb-30"
                                                name="category_id">
                                                <option data-display="@lang('front_settings.course_category')*" value="">@lang('common.select')
                                                    *</option>
                                ...
                                <div class="col-md-12 ">
                                    <div class="row mt-20">
                                        <div class="col-md-12 mt-20">
                                            <div class="primary_input">
                                                <label class="primary_input_label" for="">@lang('front_settings.overview')
                                                </label>

                                                <textarea class="primary_input_field form-control{{ $errors->has('overview') ? ' is-invalid' : '' }}" cols="0"
                                    ...
                                    <div class="row mt-20">
                                        <div class="col-md-12">
                                            <div class="primary_input">
                                                <label class="primary_input_label" for="">@lang('front_settings.outline')
                                                    <span></span></label>
                                                <textarea class="primary_input_field form-control{{ $errors->has('outline') ? ' is-invalid' : '' }}" cols="0"
                                    ...
                                    <div class="row mt-20">
                                        <div class="col-md-12">
                                            <div class="primary_input">
                                                <label class="primary_input_label" for="">@lang('front_settings.prerequisites')
                                                    <span></span></label>
                                                <textarea class="primary_input_field form-control{{ $errors->has('prerequisites') ? ' is-invalid' : '' }}"
                                    ...
                                    <div class="row mt-20">
                                        <div class="col-md-12">
                                            <div class="primary_input">
                                                <label class="primary_input_label" for="">@lang('front_settings.resources')
                                                    <span></span></label>
                                                <textarea class="primary_input_field form-control{{ $errors->has('resources') ? ' is-invalid' : '' }}" cols="0"
                                    ...
                                    <div class="row mt-20">
                                        <div class="col-md-12">
                                            <div class="primary_input">
                                                <label class="primary_input_label" for="">@lang('front_settings.stats')
                                                    <span></span></label>
                                                <textarea class="primary_input_field form-control{{ $errors->has('stats') ? ' is-invalid' : '' }}" cols="0"
