                ...
                <div class="col-lg-3">
                    <div class="row">
                        <div class="col-lg-12">
                            ...
                            @if (isset($class_time))
                                {{ html()->form('PUT', route('examTimeUpdate', $class_time->id))->attributes([
                            ...
                            @else
                                @if (userPermission(572))
                                    {{ html()->form('POST', route('examtimeSave'))->attributes([
                                            'class' => 'form-horizontal',
                                            'files' => true,
                                            'enctype' => 'multipart/form-data',
                                        ])->open() }}
                                    ...
                                    <div class="row">
                                        <div class="col-lg-12">
                                            <div class="primary_input">
                                                ...
                                                <label class="primary_input_label" for="">@lang('exam.exam_period') <span
                                        ...
                                        <div class="col">
                                            <div class="primary_input">
                                                <input
                                                    ...
                                                    value="{{ isset($class_time) ? $class_time->start_time : old('start_time') }}">
                                                <label class="primary_input_label" for="">@lang('exam.select_time') <span
                                                        class="text-danger"> *</span></label>
                                        ...
                                        <div class="col">
                                            <div class="primary_input">
                                                <input
                                                    ...
                                                    value="{{ isset($class_time) ? $class_time->end_time : old('end_time') }}">
                                                <label class="primary_input_label" for="">@lang('exam.end_time') <span
                                                        class="text-danger"> *</span></label>
                                            ...
                                            <td valign="top">
                                                ...
                                                @if (userPermission(573))
                                                    <a class="dropdown-item"
                                                        href="{{ route('examTimeEdit', $class_time->id) }}">@lang('common.edit')</a>
                                                @endif
