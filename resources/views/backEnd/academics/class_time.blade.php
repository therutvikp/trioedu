                ...
                <div class="col-lg-3">
                    <div class="row">
                        <div class="col-lg-12">
                            ...
                            @if (isset($class_time))
                                {{ html()->form('PUT', route('class-time-update', $class_time->id))->attributes([
                            ...
                            @else
                                @if (userPermission(274))
                                    {{ html()->form('POST', route('class-time'))->attributes([
                                            'class' => 'form-horizontal',
                                            'enctype' => 'multipart/form-data',
                                            'files' => true,
                                        ])->open() }}
                                    ...
                                    <div class="row">
                                        <div class="col-lg-12">
                                            <div class="primary_input">
                                                <input
                                                    class="primary_input_field form-control{{ @$errors->has('period') ? ' is-invalid' : '' }}"
                                                    type="text" name="period" autocomplete="off"
                                                    value="{{ isset($class_time) ? $class_time->period : '' }}">
                                                <input type="hidden" name="id"
                                                    value="{{ isset($class_time) ? $class_time->id : '' }}">
                                                <label class="primary_input_label" for="">@lang('common.class_period') <span
                                        ...
                                        <div class="col">
                                            <div class="primary_input">
                                                <input
                                                    ...
                                                    value="{{ isset($class_time) ? $class_time->start_time : '' }}">
                                                <label class="primary_input_label" for="">@lang('lang.select_time') <span
                                                        class="text-danger"> *</span></label>
                                        ...
                                        <div class="col">
                                            <div class="primary_input">
                                                <input
                                                    ...
                                                    value="{{ isset($class_time) ? $class_time->end_time : '' }}">
                                                <label class="primary_input_label" for="">@lang('lang.end_time') <span
                                                        class="text-danger"> *</span></label>
                            ...
                            <table id="table_id" class="table" cellspacing="0" width="100%">
                                ...
                                <tbody>
                                    @foreach ($class_times as $class_time)
                                        <tr>
                                            <td valign="top">
                                                {{ @$class_time->type == 'exam' ? 'Exam time' : 'Class time' }}</td>
                                            <td valign="top">{{ @$class_time->period }}</td>
                                            <td valign="top">{{ date('h:i A', strtotime(@$class_time->start_time)) }}
                                            </td>
                                            ...
                                            <td valign="top">
                                                ...
                                                @if (userPermission(275))
                                                    <a class="dropdown-item"
                                                        href="{{ route('class-time-edit', $class_time->id) }}">@lang('common.edit')</a>
                                                @endif
                                                @if (userPermission(276))
                                                    <a class="dropdown-item" data-toggle="modal"
                                                        data-target="#deleteClassTime{{ @$class_time->id }}"
                            ...
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    ...
                                    <div class="mt-40 d-flex justify-content-between">
                                        ...
                                        {{ html()->form('DELETE', route('class-time-delete', @$class_time->id))->attribute('enctype', 'multipart/form-data')->open() }}
