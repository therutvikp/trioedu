...
<div class="container-fluid">
    ...
    <div class="row">
        <div class="col-lg-12">
            ...
            <input type="hidden" name="update_teacher_id" id="update_teacher_id"
                value="{{ isset($teacher_detail) ? $teacher_detail->id : '' }}">
            @if (isset($assigned_id))
                <input type="hidden" name="assigned_id" id="assigned_id" value="{{ @$assigned_id }}">
            @endif
            <div class="row mt-25">
                <div class="col-lg-12 mt-30-md">
                    <select class="primary_selectModal form-control" name="subject" id="subject"
            ...
            <div class="row mt-25">
                <div class="col-lg-12 mt-30-md">
                    <div class="primary_input">
                        <input name="teacher_name" class="primary_input_field read-only-input" type="text"
                            readonly="true" id="teacher_name"
                            value="{{ isset($teacher_detail) ? $teacher_detail->full_name : '' }}">
                        <input name="teacher_id" class="primary_input_field read-only-input" type="hidden"
                            readonly="true" id="teacher_id"
                            value="{{ isset($teacher_detail) ? $teacher_detail->id : '' }}">
            ...
            <div class="row mt-25">
                <div class="col-lg-12 mt-30-md">
                    <select class="primary_selectModal form-control" name="room" id="room"
                        onchange="changeRoom()">
        ...
        function changeRoom() {
            ...
            $.ajax({
                ...
                success: function(data) {
                    ...
                    appendRow +=
                        "<input type='checkbox' id='all_days' onclick='selectAll()' class='common-checkbox' name='all_days[]' value='0'>";
                    appendRow +=
                    " <label for='all_days'>{{ __('lang.select') }} {{ __('lang.all') }}</label>";
                    appendRow += "</div>";
                    ...
                    $.each(data, function(i, item) {
                        $.each(item, function(i, day) {
                            ...
                            appendRow += "<input type='checkbox' id='days_" + day.id +
                                "' class='common-checkbox day-checkbox' name='day_ids[]' value='" +
                                day.id + "'>";
                            appendRow += "<label for='days_" + day.id + "'>" + day.name +
                                "</label>";
                            appendRow += "</div>";
                        });
                    });
