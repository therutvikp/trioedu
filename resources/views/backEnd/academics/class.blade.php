            ...
            <div class="row">
                ...
                <div class="col-lg-3">
                    <div class="row">
                        <div class="col-lg-12">
                            @if (isset($sectionId))
                                {{ html()->form('POST', route('class_update'))->attribute('class', 'form-horizontal')->attribute('files', true)->open() }}
                            @else
                                @if (userPermission('class_store'))
                                    {{ html()->form('POST', route('class_store'))->attribute('class', 'form-horizontal')->attribute('files', true)->open() }}
                                @endif
                            @endif
                            <div class="white-box">
                                ...
                                <div class="add-visitor">
                                    ...
                                    <div class="row mt-25">
                                        <div class="col-lg-12">
                                            <label class="primary_input_label" for="">@lang('common.shift')<span class="text-danger"> *</span></label>
                                                ...
                                                <div class="">
                                                    @if(isset($shiftId))
                                                        <input type="checkbox" id="shift{{@$shift->id}}"
                                                               ...
                                                               name="shift[]"
                                                               value="{{@$shift->id}}" {{in_array(@$shift->id, @$shiftId)? 'checked': ''}}>
