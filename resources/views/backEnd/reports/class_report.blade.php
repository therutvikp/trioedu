        ...
        <div class="white-box mt-40">
            <div class="row">
                <div class="col-lg-6 no-gutters">
                    <div class="main-title">
                        <h3 class="mb-15">@lang('reports.class_report_for_class') {{@$search_class->class_name}}, {{$sectionInfo != ""? 'section ('. $sectionInfo->section_name.')': ''}} @if(shiftEnable()) , {{$shiftInfo != ""? 'shift ('. $shiftInfo->name.')': ''}} @endif</h3>
                    </div>
                </div>
            </div>
            <div class="row">
