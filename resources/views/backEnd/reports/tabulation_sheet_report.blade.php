                                    ...
                                    <div class="card-header">
                                        <div class="row align-items-center">
                                            ...
                                            <div class=" col-lg-8 text-left text-lg-right mt-30-md">
                                                <h3 class="text-white"> {{isset(generalSetting()->school_name)?generalSetting()->school_name:'Trio School Management ERP'}} </h3>
                                                <p class="text-white mb-0"> {{isset(generalSetting()->address)?generalSetting()->address:'Trio School Adress'}} </p>
                                                ...
                                                <div class="col-lg-3">
                                                    <ul class="student_info">
                                                        ...
                                                        <li>
                                                            ...
                                                            <p class="bold_text">: {{$tabulation_details['shift']}}</p>
                                                        </li>
                                                        @endif
                                                    </ul>
                                                </div>
                                    ...
                                    <div class="single-report-admit mt-50">
                                        <div class="student_marks_table pt-0 mt-0">
                                            <div class="table-responsive">
                                                <table class="mt-0 mb-20 table table-striped table-bordered scrolled_table" style="border: 1px solid #f1f1f1 !important">
                                                    <thead>
                                                        <tr>
                                                            @foreach($subjects as $subject)
                                                                @php
                                                                    ...
                                                                    if(shiftEnable()){
                                                                        $mark_parts      = App\SmAssignSubject::getNumberOfPart($subject_ID, $class_id, $section_id, $exam_term_id, $shift_id);
                                                                    }else{
                                                            ...
                                                            <table class="mt-30 mb-20 table table-bordered w-100 scrolled_table">
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        @foreach($subjects as $subject)
                                                                            @php
                                                                                $subject_ID    = $subject->subject_id;
                                                                                $subject_Name   = $subject->subject->subject_name;
                                                                                $mark_parts      = App\SmAssignSubject::getNumberOfPart($subject_ID, $class_id, $section_id, $exam_term_id, shiftEnable() ? $shift_id : '');
                                                                            @endphp
                                                                ...
                                                                <tbody>
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td>
                                                                            @php
                                                                                $tola_mark_by_subject = App\SmAssignSubject::getSumMark($student->id, $subject_ID, $class_id, $section_id, $exam_term_id, shiftEnable() ? $shift_id : '');
                                                                                $marks_by_students  = $marks_by_students + $tola_mark_by_subject;
                                                                            @endphp
                                                                            {{$tola_mark_by_subject}}
                                                                        </td>
