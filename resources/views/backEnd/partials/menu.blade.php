...
<style>
    ...
    button#mobileSelectorDropdown + .dropdown-menu .trio_session,
    button#mobileSelectorDropdown + .dropdown-menu .languageChange {
        padding: 0 16px;
    }

    button#mobileSelectorDropdown + .dropdown-menu .trio_session:hover,
        ...
        <div class="col-lg-12 p-0">
            <div class="header_iner d-flex justify-content-between align-items-center">
                ...
                <div class="header_right d-flex justify-content-between align-items-center">
                    ...
                    <select name="#" class="nice_Select bgLess mb-0 trio_session" id="trio_session">
                    ...
                    {{-- @if (@$styles && Auth::user()->role_id == 1)
                        @if (generalSetting()->style_btn == 1)
                            <select class="nice_Select bgLess mb-0 trio_theme_style" id="trio_theme_style">
                    ...
                    <div class="dropdown d-sm-none">
                        ...
                        <select name="#" class="nice_Select bgLess mb-0 trio_session" id="trio_session_mbl">
                            @foreach (academicYears() as $academic_year)
                                @if (moduleStatusCheck('University'))
                                    <option value="{{ @$academic_year->id }}"
                                        {{ getAcademicId() == @$academic_year->id ? 'selected' : '' }}>
...
<script>
    ...
    $(document).ready(function () {
        ...
        $('#trio_session_mbl').on('change', function () {
