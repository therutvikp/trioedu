...
<nav id="sidebar">
    ...
    <li>
    <a href="#subMenuTrioInvoice" data-toggle="collapse" aria-expanded="false" class="dropdown-toggle">
        <span class="flaticon-accounting"></span> Invoice </a>
    <ul class="collapse list-unstyled" id="subMenuTrioInvoice">
        <li><a href="{{url('trio/invoice-create')}}">Invoice Create</a></li>
        <li><a href="{{url('trio/invoice-list')}}">Invoice list</a></li>
        <li><a href="{{url('trio/invoice-category')}}">Invoice Category</a></li>
        <li><a href="{{url('trio/invoice-setting')}}">Invoice Setting</a></li>
