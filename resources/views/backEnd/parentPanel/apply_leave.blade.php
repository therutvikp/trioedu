            ...
            <div class="row">
                <div class="col-lg-3">
                    <div class="row">
                        <div class="col-lg-12">
                            @if (isset($apply_leave))
                            {{ html()->form('PUT', route('parent-leave-update', $apply_leave->id))->attributes([
                            ...
                            @else
                                @if (userPermission('parent-leave-store'))
                                {{ html()->form('POST', route('parent-leave-store'))->attributes([
                                        'class' => 'form-horizontal',
                                        'files' => true,
                                        'enctype' => 'multipart/form-data',
                                    ])->open() }}                                
                                                            ...
                                                            <div class="modal-body">
                                                                ...
                                                                <div class="mt-40 d-flex justify-content-between">
                                                                    <button type="button" class="primary-btn tr-bg"
                                                                        ...
                                                                        {{ html()->form('DELETE', route('parent-leave-delete', $apply_leave->id))->attribute('enctype', 'multipart/form-data')->open() }}
