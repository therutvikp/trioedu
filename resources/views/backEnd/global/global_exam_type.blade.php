                ...
                <div class="col-lg-3">
                    <div class="row">
                        <div class="col-lg-12">
                            ...
                            @if (isset($exam_type_edit))
                                {{ html()->form('POST', route('global_exam_type_update'))->attributes([
                            ...
                            @else
                                @if (userPermission(209))
                                    {{ html()->form('POST', route('global_exam_type_store'))->attributes([
                                            'class' => 'form-horizontal',
                                            'files' => true,
                                            'enctype' => 'multipart/form-data',
                                        ])->open() }}
                                        ...
                                        <div class="col-lg-12">
                                            ...
                                            <div class="primary_input">
                                                ...
                                                <input
                                                    ...
                                                    value="{{ isset($exam_type_edit) ? $exam_type_edit->title : '' }}">
                                                <input type="hidden" name="id"
                                                    value="{{ isset($exam_type_edit) ? $exam_type_edit->id : Request::old('exam_type_title') }}">
                                                    ...
                                                    <x-drop-down>
                                                        ...
                                                        @if (userPermission(210))
                                                            <a class="dropdown-item"
                                                                href="{{ route('global_exam_type_edit', [$exams_type->id]) }}">@lang('common.edit')</a>
                                                        @endif
                            ...
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    ...
                                    <div class="mt-40 d-flex justify-content-between">
                                        ...
                                        <a href="{{ route('global_exam_type_delete', [@$exams_type->id]) }}"
                                            class="text-light">
