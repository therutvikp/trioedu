<div class="container-fluid">
    <div class="row">
        <div class="col-lg-12">
            {{ html()->form('POST', route('studyMaterialAssigned'))->attributes([
            ...
            <table id="" class="display school-table school-table-style-parent-fees" cellspacing="0"
                ...
                <tbody>
                    @foreach ($uploadContents as $value)
                        <tr>
                            <td>
                                <input type="checkbox" id="study_mat.{{ $value->id }}"
                                    class="common-checkbox study_material" name="study_material[]"
                                    value="{{ $value->id }}">
