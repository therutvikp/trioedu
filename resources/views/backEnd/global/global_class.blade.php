                ...
                <div class="col-lg-3">
                    <div class="row">
                        <div class="col-lg-12">
                            ...
                            @if (isset($sectionId))
                                {{ html()->form('POST', route('global_class_update'))->attributes([
                            ...
                            @else
                                @if (userPermission(266))
                                    {{ html()->form('POST', route('global_class_store'))->attributes([
                                            'class' => 'form-horizontal',
                                            'files' => true,
                                            'enctype' => 'multipart/form-data',
                                        ])->open() }}
                                    ...
                                    <div class="row">
                                        <div class="col-lg-12">
                                            <div class="primary_input">
                                                <label class="primary_input_label" for="">@lang('common.name')
                                                    <span>*</span></label>
                                                <input
                                                ...
                                                <div class="">
                                                    @if (isset($sectionId))
                                                        <input type="checkbox" id="section{{ @$section->id }}"
                                                            ...
                                                            {{ in_array(@$section->id, @$sectionId) ? 'checked' : '' }}>
                                                        <label for="section{{ @$section->id }}">@lang('common.section')
                                    ...
                                    <tbody>
                                        @foreach ($classes as $class)
                                            <tr>
                                                ...
                                                <td>
                                                    @if (@$class->globalGroupclassSections)
                                                        @foreach ($class->globalGroupclassSections as $section)
                                                            <a
                                                                href="{{ route('sorting_student_list_section', [$class->id, $section->globalSectionName->id]) }}">{{ @$section->globalSectionName->section_name }}-({{ total_no_records($class->id, $section->globalSectionName->id) }})</a>
                                                            {{ !$loop->last ? ', ' : '' }}
                                                        @endforeach
                                                    @endif
                                                </td>
                                                ...
                                                <td>
                                                    <a
                                                        href="{{ route('sorting_student_list', [$class->id]) }}">{{ $class->records_count }}</a>
                                                </td>
                                                    ...
                                                    @php
                                                        $routeList = [
                                                            userPermission(263)
                                                               ...
                                                               href="' .
                                                                    route('global_class_edit', [@$class->id]) .
                                                                    '">' .
                                                                    __('common.edit') .
                                                                    '</a>'
                                                                : null,
                                                            ...
                                                            userPermission(264)
                                                               ...
                                                               data-target="#deleteClassModal' .
                                                                    ...
                                                                    '"
                                                               href="' .
                                                                    route('global_class_delete', [@$class->id]) .
                                                                    '">' .
                                                                    __('common.delete') .
                                                                    '</a>'
                                                                : null,
