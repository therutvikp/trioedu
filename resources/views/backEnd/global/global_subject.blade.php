                ...
                <div class="col-lg-3">
                    <div class="row">
                        <div class="col-lg-12">
                            ...
                            @if (isset($subject))
                                {{ html()->form('POST', route('global_subject_update'))->attributes([
                            ...
                            @else
                                @if (userPermission(258))
                                    {{ html()->form('POST', route('global_subject_store'))->attributes([
                                            'class' => 'form-horizontal',
                                            'files' => true,
                                            'enctype' => 'multipart/form-data',
                                        ])->open() }}
                            ...
                            <div class="white-box">
                                <div class="add-visitor">
                                    <div class="row">
                                        <div class="col-lg-12">
                                            ...
                                            <div class="primary_input">
                                                <label class="primary_input_label" for="">@lang('academics.subject_name')
                                                    <span>*</span></label>
                                                <input
                                    ...
                                    <div class="row  mt-40">
                                        <div class="col-lg-12">
                                            <div class="primary_input">
                                                <label class="primary_input_label" for="">@lang('academics.subject_code')
                                                    <span>*</span></label>
                                                <input
                                                        ...
                                                        $routeList = [
                                                            userPermission(259)
                                                                ? '<a class="dropdown-item" href="' .
                                                                    route('global_subject_edit', [@$subject->id]) .
                                                                    '">' .
                                                                    __('common.edit') .
                                                                    '</a>'
                                                                : null,
                                                    ...
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-body">
                                                            ...
                                                            <div class="mt-40 d-flex justify-content-between">
                                                                ...
                                                                <a href="{{ route('global_subject_delete', [@$subject->id]) }}"
                                                                    class="text-light">
