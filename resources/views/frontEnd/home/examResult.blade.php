@php $page_title="All about Trio School management system; School management software"; @endphp
                                                        ...
                                                        <div class="d-flex">
                                                            ...
                                                            <div class="col-lg-8 text-center">
                                                                ...
                                                                <p class="text-white mb-0" style="font-size: 16px;">
                                                                    {{ isset(generalSetting()->address) ? generalSetting()->address : 'Trio School Address' }}
                                                                </p>
                                                                <p class="text-white mb-0" style="font-size: 16px;">
