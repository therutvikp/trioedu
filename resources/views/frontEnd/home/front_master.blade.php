...
<head>
    ...
    <title>{{ $setting->site_title ? $setting->site_title : 'Trio Edu ERP' }}</title>
    ...
    <link rel="stylesheet" href="{{ asset('public/') }}/frontend/css/trio.css" />
                ...
                <div class="container box-1420">
                    ...
                    <a class="navbar-brand" href="{{ url('/') }}/home">
                        <img class="w-75"
                            ...
                            alt="Trio Logo" style="max-width: 150px;">
                    </a>
