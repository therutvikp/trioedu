			...
			<div class="row footer_inner">
				...
				<div class="col-lg-3 col-sm-6">
					<aside class="f_widget ab_widget">
						...
						<ul>
							<li><a href="#"></a>Trio Health Care</a></li><a href="#">
                            <li><a href="#"></a>Trio Children’s Health</a></li>
							<li><a href="#"></a>Interdisciplinary Research</a></li>
							<li><a href="#"></a>Trio Online</a></li>
							<li><a href="#"></a>Trio Research Centers</a></li>
						</ul>
					</aside>
				</div>
				<div class="col-lg-3 col-sm-6">
			...
			<div class="row single-footer-widget">
				<div class="col-lg-8 col-md-9">
					<div class="copy_right_text">
						<p>Copyright © 2018 All rights reserved <a href="#">Trio</a>. The Ultimate Education ERP</p>
					</div>
				</div>
