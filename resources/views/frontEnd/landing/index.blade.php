...
<head>
    ...
    <title> Trio school management software & School management system </title>
    <meta name="description" content="Trio is 100+ unique feature enable school management software system. It can manage all type of school, academy and any educational institution. ">
    ...
    <script type="application/ld+json">
        [ {
          ...
          "name" : "TRIO - Best School Management software system",
          "url" : "http://trioedu.com/",
          "author" : {
            "@type" : "Company",
            "name" : "Spondon IT"
          },
          ...
          "downloadUrl" : "http://trioedu.com",
          "operatingSystem" : "2019",
          "requirements" : "in a complete",
          "screenshot" : "http://trioedu.com/public/landing/img/dashboard_preview.png",
          "softwareVersion" : "2.0",
    ...
    <meta name="twitter:site" content="@TrioEdu"/>
    <meta name="twitter:creator" content="@TrioEdu"/>
    <meta name="twitter:url" content="//trio.com/"/>
    <meta name="twitter:title" The Ultimate Education Management System For School,  Institute & Academy"/>
    <meta name="twitter:description" content="Trio is a well known School management system and its ERP based Software. So try the free demo today!. Cause Trio offers 100+  featured, well-documented and latest academic management software system.. By this multipurpose software system, you can easily manage your school,  university or any kind of organization educational institute. So we can provide you speedy, Secure and clean coded Flexible academy and school management system at affordable prices!"/>
    <meta property="og:image" content="http://trioedu.com/public/landing/img/dashboard_preview.png"/>


    <!-- Open Graph data -->
    <meta property="og:type" content="website" />
    <meta property="og:url" content="//trioedu.com/"/>
    <meta property="og:image" content="//trioedu.com/public/landing/img/dashboard_preview.png"/>
    <meta property="og:title" content="School Management ERP Software & School Management System - Trio"/>

    <meta property="og:description" content="Trio is a well known School management system and its ERP based Software. So try the free demo today!. Cause Trio offers 100+  featured, well-documented and latest academic management software system.. By this multipurpose software system, you can easily manage your school,  university or any kind of organization educational institute. So we can provide you speedy, Secure and clean coded Flexible academy and school management system at affordable prices!"/>
    <meta property="og:site_name" content="Trio" />

    <link rel="canonical" href="http://trioedu.com" hreflang="en-us" />
                ...
                <div class="banner_text">
                    <div class="banner_text_iner">
                        ...
                        <p>Managing various administrative tasks in one place is now quite easy and time
                            savior with this TRIO and Give your valued time to your institute that will
                            increase next generation productivity for our society.</p>
                        @if(!moduleStatusCheck('Saas'))
                            <a  class="btn_1" target="_blank" href="mailto:hello@aorasoft.com?subject=Request for TrioEdu SaaS Application Demo!&body=Could you please arrange a demo for the TrioEdu SaaS application at your earliest convenience?"> <i class="ti-email"></i> For Saas Demo</a>
                        @endif
        ...
        <div class="row align-items-center">
            <div class="col-lg-12">
                <nav class="navbar navbar-expand-lg navbar-light">
                    ...
                    <!-- <a class="btn_1 d-none d-lg-block" target="_blank" href="http://salespanel.trioedu.com/">Purchase</a> -->
            ...
            <div class="col-sm-6 col-xl-3">
                <div class="single_feature">
                    <div class="single_feature_part">
                        ...
                        <p>TRIO has all in one place. You’ll find everything what you are looking into education
            ...
            <div class="col-sm-6 col-xl-3">
                <div class="single_feature">
                    <div class="single_feature_part">
                        ...
                        <p>You know! Smart Idea always comes to well planners. And Our TRIO is Smart for its Well
                            Documentation.
                        </p>
                    </div>
                </div>
        ...
        <div class="row align-items-center">
            ...
            <div class="col-md-5 col-lg-5">
                <div class="video_section_text">
                    <h2>Take A look Our TRIO Overview in Video</h2>
    ...
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-xl-6 col-md-8">
                <div class="section_tittle text-center">
                    <h5>AMazing Features</h5>
                    <h2>More Features Has TRIO</h2>
                    <p>it's vast! Trio has more additional feature that will expect in a complete solution.</p>
                </div>
            </div>
        </div>
        <div class="row justify-content-center">
...
<section class="contact_us padding_top" id="Support">
    <div class="container">
        ...
        <div class="row justify-content-center">
            ...
            <div class="col-md-6">
                <a href="https://ticket.aorasoft.com/trioedu" target="_blank">
                    <div class="single_feature">
                        <div class="single_feature_part">
            ...
            <div class="col-md-6">
                <a class="support-link" target="_blank" href="https://ticket.aorasoft.com/trioedu">
                    <div class="single_feature">
                        <div class="single_feature_part">
                            <span class="single_feature_icon"><i class="ti-write"></i></span>
        ...
        <div class="row justify-content-center">
            <div class="col-lg-8">
                <div class="footer_area_text">
                    ...
                    <p>We Believe! It won’t a wrong decision in Purchasing our TRIO for your Institute.</p>
                    <!-- <a href="http://salespanel.trioedu.com/" class="footer_btn"> <i class="ti-shopping-cart-full"></i> -->
        ...
        <div class="row justify-content-center">
            <div class="col-lg-8">
                <div class="copyright_text">
                    <p> <img src="{{asset('public/landing/img/copyright.svg')}}" alt="#"> 2019-2020 TrioEdu - Ultimate Education ERP. All Rights
